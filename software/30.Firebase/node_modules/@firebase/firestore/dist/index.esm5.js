...
import { XhrIo as D, EventType as x, ErrorCode as _, createWebChannelTransport as N, getStatEventTarget as A, FetchXmlHttpFactory as k, WebChannel as C, Event as O, Stat as V } from "@firebase/webchannel-wrapper";
 ...
 * limitations under the License.
 */
var F = "9.9.2", L = new l("@firebase/firestore");
...
function U(t) {
    ...
    if (L.logLevel <= h.DEBUG) {
        var i = e.map(G);
        L.debug.apply(L, r([ "Firestore (" + F + "): " + t ], i));
    }
}

function B(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (L.logLevel <= h.ERROR) {
        var i = e.map(G);
        L.error.apply(L, r([ "Firestore (" + F + "): " + t ], i));
    }
}
 ...
 */ function K(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (L.logLevel <= h.WARN) {
        var i = e.map(G);
        L.warn.apply(L, r([ "Firestore (" + F + "): " + t ], i));
    }
}
 ...
 */ function j(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (" + F + ") INTERNAL ASSERTION FAILED: " + t;
 ...
 * index ID.
 */ function It(t, e) {
    var n = at(t.collectionGroup, e.collectionGroup);
    if (0 !== n) return n;
    for (var r = 0; r < Math.min(t.fields.length, e.fields.length); ++r) if (0 !== (n = Tt(t.fields[r], e.fields[r]))) return n;
    return at(t.fields.length, e.fields.length);
}

/** Returns a debug representation of the field index */ gt.UNKNOWN_ID = -1;
...
function Tt(t, e) {
    var n = yt.comparator(t.fieldPath, e.fieldPath);
    return 0 !== n ? n : at(t.kind, e.kind);
}
 ...
 */ function Dt(t, e) {
    ...
    return new _t(i, mt.empty(), e);
}

/** Creates a new offset based on the provided document. */ function xt(t) {
    return new _t(t.readTime, t.key, -1);
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var At = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", kt = /** @class */ function() {
    function t() {
...
function Ct(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== H.FAILED_PRECONDITION || t.message !== At) throw t;
 ...
 */ var Ot = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        this.T = new J, this.transaction.oncomplete = function() {
            ...
            e.error ? n.T.reject(new Ft(t, e.error)) : n.T.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Bt(e.target.error);
            n.T.reject(new Ft(t, r));
        };
    }
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return U("SimpleDb", "Removing database:", t), qt(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
    ...
    t.prototype.k = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, n) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === r.name ? n(new Y(H.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === r.name ? n(new Y(H.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + r)) : n(new Ft(t, r));
                        }, i.onupgradeneeded = function(t) {
                            U("SimpleDb", 'Database "' + r.name + '" requires upgrade from version:', t.oldVersion);
                            var e = t.target.result;
                            r.P.M(e, i.transaction, t.oldVersion, r.version).next((function() {
                  ...
                  case 2:
                    return [ 2 /*return*/ , (this.O && (this.db.onversionchange = function(t) {
                        return r.O(t);
                    }), this.db) ];
                }
            }));
        ...
        this.O = t, this.db && (this.db.onversionchange = function(e) {
            return t(e);
        });
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return a.db = n.sent(), r = Vt.open(a.db, t, e ? "readonly" : "readwrite", i), s = o(r).next((function(t) {
                                    return r.R(), t;
                                })).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return r.abort(t), Ot.reject(t);
 ...
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Lt(t) {
 ...
 */ var Pt = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return U("SimpleDb", "ADD", this.store.name, t, t), qt(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return qt(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), U("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return U("SimpleDb", "DELETE", this.store.name, t), qt(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return U("SimpleDb", "COUNT", this.store.name), qt(this.store.count());
    ...
    t.prototype.Y = function(t) {
        ...
        return new Ot((function(r, i) {
            t.onerror = function(t) {
                ...
                if (i) {
                    var o = new Rt(i), u = e(i.primaryKey, i.value, o);
                    if (u instanceof Ot) {
                        var s = u.catch((function(t) {
                            return o.done(), Ot.reject(t);
                        }));
                        n.push(s);
                    }
...
/** This class is responsible for the scheduling of Index Backfiller. */ var Kt = /** @class */ function() {
    function t(t, e) {
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Lt(i = n.sent()) ? (U("IndexBackiller", "Ignoring IndexedDB error during index backfill: ", i), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    /** Returns the next offset based on the provided documents. */ t.prototype.st = function(t, e) {
        ...
        return e.changes.forEach((function(t, e) {
            var r = xt(e);
            Nt(r, n) > 0 && (n = r);
        })), new _t(n.readTime, n.documentKey, Math.max(e.batchId, t.largestBatchId));
    }, t;
}(), jt = /** @class */ function() {
    function t(t, e) {
        var n = this;
...
var Ht = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, Jt.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, Jt.BLACK, null, null));
    }, 
...
var Xt = /** @class */ function() {
    function t(t) {
        this.comparator = t, this.data = new Ht(this.comparator);
    }
 ...
 */ var te = /** @class */ function() {
    ...
    t.prototype.unionWith = function(e) {
        for (var n = new Xt(yt.comparator), r = 0, i = this.fields; r < i.length; r++) {
            var o = i[r];
            n = n.add(o);
        }
...
/** True if and only if the Base64 conversion functions are available. */ function ee() {
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function ue(t) {
    return "string" == typeof t ? ne.fromBase64String(t) : ne.fromUint8Array(t);
}
 ...
 */ function ce(t) {
    var e = ie(t.mapValue.fields.__local_write_time__.timestampValue);
...
/** Returns whether the value represents -0. */ function de(t) {
 ...
 */ function pe(t) {
    return "number" == typeof t && Number.isInteger(t) && !de(t) && t <= Number.MAX_SAFE_INTEGER && t >= Number.MIN_SAFE_INTEGER;
}
...
/** Extracts the backend's type order for the provided value. */ function me(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? se(t) ? 4 /* ServerTimestampValue */ : Ce(t) ? 9007199254740991 /* MaxValue */ : 10 /* ObjectValue */ : j();
}
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            var n = ie(t.timestampValue), r = ie(e.timestampValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            return oe(t.geoPointValue.latitude) === oe(e.geoPointValue.latitude) && oe(t.geoPointValue.longitude) === oe(e.geoPointValue.longitude);
        }(t, e);

      case 2 /* NumberValue */ :
        return function(t, e) {
            if ("integerValue" in t && "integerValue" in e) return oe(t.integerValue) === oe(e.integerValue);
            if ("doubleValue" in t && "doubleValue" in e) {
                var n = oe(t.doubleValue), r = oe(e.doubleValue);
                return n === r ? de(n) === de(r) : isNaN(n) && isNaN(r);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return ct(t.arrayValue.values || [], e.arrayValue.values || [], ge);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (zt(n) !== zt(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !ge(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function be(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            var n = oe(t.integerValue || t.doubleValue), r = oe(e.integerValue || e.doubleValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = at(oe(t.latitude), oe(e.latitude));
            return 0 !== n ? n : at(oe(t.longitude), oe(e.longitude));
      ...
      case 10 /* ObjectValue */ :
        return function(t, e) {
            if (t === ve.mapValue && e === ve.mapValue) return 0;
            if (t === ve.mapValue) return 1;
            if (e === ve.mapValue) return -1;
...
function Ie(t, e) {
    ...
    var n = ie(t), r = ie(e), i = at(n.seconds, r.seconds);
...
/** Returns true if `value` is an ArrayValue. */ function xe(t) {
...
/** Returns true if `value` is NaN. */ function Ne(t) {
...
/** Creates a deep copy of `source`. */ function ke(t) {
    ...
    if (t.mapValue) {
        ...
        return Qt(t.mapValue.fields, (function(t, n) {
            return e.mapValue.fields[t] = ke(n);
        })), e;
    }
    if (t.arrayValue) {
        for (var n = {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = ke(t.arrayValue.values[r]);
        return n;
    }
    return Object.assign({}, t);
}

/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */ function Ce(t) {
    return "__max__" === (((t.mapValue || {}).fields || {}).__type__ || {}).stringValue;
}

/** Returns the lowest value for the given value type (inclusive). */ function Oe(t) {
    return "nullValue" in t ? ye : "booleanValue" in t ? {
        booleanValue: !1
        ...
        bytesValue: ""
    } : "referenceValue" in t ? Se(he.empty(), mt.empty()) : "geoPointValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
...
/** Returns the largest value for the given value type (exclusive). */ function Ve(t) {
    return "nullValue" in t ? {
        ...
        bytesValue: ""
    } : "bytesValue" in t ? Se(he.empty(), mt.empty()) : "referenceValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
 ...
 */ var Fe = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!Ae(e = (e.mapValue.fields || {})[t.get(n)])) return null;
    ...
    t.prototype.set = function(t, e) {
        this.getFieldsMap(t.popLast())[t.lastSegment()] = ke(e);
    }, 
    /**
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = ke(t) : i.push(o.lastSegment());
        }));
 ...
 */ function Le(t) {
    var e = [];
    return Qt(t.fields, (function(t, n) {
        var r = new yt([ t ]);
        if (Ae(n)) {
...
var Pe = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , ft.min(), ft.min(), Fe.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, ft.min(), Fe.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, ft.min(), Fe.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
    ...
    t.prototype.convertToNoDocument = function(t) {
        return this.version = t, this.documentType = 2 /* NO_DOCUMENT */ , this.data = Fe.empty(), 
        this.documentState = 0 /* SYNCED */ , this;
    }, 
    /**
    ...
    t.prototype.convertToUnknownDocument = function(t) {
        return this.version = t, this.documentType = 3 /* UNKNOWN_DOCUMENT */ , this.data = Fe.empty(), 
...
function Be(t) {
    ...
    if (null === e.ut) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            return (e = t).field.canonicalString() + e.op.toString() + Ee(e.value);
            var e;
        ...
        })).join(","), fe(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
...
function Ke(t, e) {
    ...
    i.op !== o.op || !i.field.isEqual(o.field) || !ge(i.value, o.value)) return !1;
    var i, o;
...
/** Returns the field filters that target the given field path. */ function je(t, e) {
    return t.filters.filter((function(t) {
        return t instanceof We && t.field.isEqual(e);
    }));
}
 ...
 */ function ze(t, e, n) {
    ...
    for (var r = ye, i = !0, o = 0, u = je(t, e); o < u.length; o++) {
        var s = u[o], a = ye, c = !0;
        switch (s.op) {
          case "<" /* LESS_THAN */ :
 ...
 */ function Qe(t, e, n) {
    // Process all filters to find a value for the current field segment
    for (var r = ve, i = !0, o = 0, u = je(t, e); o < u.length; o++) {
        var s = u[o], a = ve, c = !0;
        switch (s.op) {
          case ">=" /* GREATER_THAN_OR_EQUAL */ :
          case ">" /* GREATER_THAN */ :
...
/** Returns the number of segments of a perfect index for this target. */ var We = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.ct(t, e, r) : new He(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new $e(t, r) : "in" /* IN */ === e ? new Ze(t, r) : "not-in" /* NOT_IN */ === e ? new tn(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new en(t, r) : new n(t, e, r);
    }, n.ct = function(t, e, n) {
        return "in" /* IN */ === e ? new Ye(t, n) : new Je(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.at(be(e, this.value)) : null !== e && me(this.value) === me(e) && this.at(be(e, this.value));
...
}(We), Ye = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = Xe("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = Xe("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** A Filter that implements the array-contains operator. */ var $e = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return xe(e) && we(e.arrayValue, this.value);
    }, n;
}(We), Ze = /** @class */ function(e) {
    function n(t, n) {
    ...
    return t(n, e), n.prototype.matches = function(t) {
        ...
        return !(!xe(n) || !n.arrayValue.values) && n.arrayValue.values.some((function(t) {
            return we(e.value.arrayValue, t);
        }));
    }, n;
}(We), nn = function(t, e) {
    this.position = t, this.inclusive = e;
}, rn = function(t, e /* ASCENDING */) {
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

/** A Filter that implements the IN operator. */ function on(t, e) {
...
function un(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? mt.comparator(mt.fromName(u.referenceValue), n.key) : be(u, n.data.field(o.field)), 
 ...
 */ function sn(t, e) {
    ...
    for (var n = 0; n < t.position.length; n++) if (!ge(t.position[n], e.position[n])) return !1;
    return !0;
}
...
/** Creates a new Query instance with the options provided. */ function cn(t, e, n, r, i, o, u, s) {
    return new an(t, e, n, r, i, o, u, s);
}
 ...
 */ function vn(t) {
    ...
    if (null === e.lt) {
        ...
        n.isKeyField() || e.lt.push(new rn(n)), e.lt.push(new rn(yt.keyField(), "asc" /* ASCENDING */)); else {
            ...
            if (!i) {
                ...
                e.lt.push(new rn(yt.keyField(), a));
            }
        }
    }
    return e.lt;
 ...
 */ function yn(t) {
    var e = W(t);
    if (!e.ft) if ("F" /* First */ === e.limitType) e.ft = Ue(e.path, e.collectionGroup, vn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = vn(e); r < i.length; r++) {
            var o = i[r], u = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new rn(o.field, u));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var s = e.endAt ? new nn(e.endAt.position, e.endAt.inclusive) : null, a = e.startAt ? new nn(e.startAt.position, e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
                e.ft = Ue(e.path, e.collectionGroup, n, e.filters, e.limit, s, a);
    }
    return e.ft;
}
...
function gn(t, e) {
    return Ke(yn(t), yn(e)) && t.limitType === e.limitType;
}
...
function bn(t) {
    return "Query(target=" + function(t) {
        ...
        t.filters.length > 0 && (e += ", filters: [" + t.filters.map((function(t) {
            return (e = t).field.canonicalString() + " " + e.op + " " + Ee(e.value);
            /** Returns a debug description for `filter`. */            var e;
            /** Filter that matches on key fields (i.e. '__name__'). */        })).join(", ") + "]"), 
        fe(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return function(t) {
                return t.field.canonicalString() + " (" + t.dir + ")";
            }(t);
 ...
 */
        ...
        }(t.startAt, vn(t), e)) && !(t.endAt && !function(t, e, n) {
            var r = un(t, e, n);
            return t.inclusive ? r >= 0 : r > 0;
        }(t.endAt, vn(t), e));
    }(t, e);
 ...
 */ function Tn(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = vn(t); i < o.length; i++) {
            var u = o[i], s = Sn(u, e, n);
            if (0 !== s) return s;
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ var Nn = function() {
 ...
 */ function An(t, e, n) {
    ...
    }(n, e) : t instanceof Vn ? Mn(t, e) : t instanceof Rn ? Fn(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Cn(t, e), r = Pn(n) + Pn(t._t);
        return De(n) && De(t._t) ? xn(r) : Dn(t.wt, r);
    }(t, e);
}
 ...
 */ function kn(t, e, n) {
    ...
    // applications.
    return t instanceof Vn ? Mn(t, e) : t instanceof Rn ? Fn(t, e) : n;
}
 ...
 */ function Cn(t, e) {
    return t instanceof Ln ? De(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var On = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n;
}(Nn), Vn = /** @class */ function(e) {
    function n(t) {
        var n = this;
...
/** Transforms an array value via a union operation. */ function Mn(t, e) {
    for (var n = qn(e), r = function(t) {
        n.some((function(e) {
            return ge(e, t);
        })) || n.push(t);
...
/** Transforms an array value via a remove operation. */ var Rn = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
...
function qn(t) {
    return xe(t) && t.arrayValue.values ? t.arrayValue.values.slice() : [];
}
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Un = function(t, e) {
 ...
 */
/** Returns true if the preconditions is valid for the given document. */ function Gn(t, e) {
 ...
 */ function zn(t, e) {
    ...
    // mask is null when sets or deletes are applied to the current document.
        if (null === e) return t.isNoDocument() ? new rr(t.key, Kn.none()) : new Jn(t.key, t.data, Kn.none());
    for (var n = t.data, r = Fe.empty(), i = new Xt(yt.comparator), o = 0, u = e.fields; o < u.length; o++) {
        var s = u[o];
        if (!i.has(s)) {
            var a = n.field(s);
    ...
    return new Xn(t.key, r, new te(i.toArray()), Kn.none());
}
 ...
 */ function Qn(t, e, n) {
    t instanceof Jn ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = Zn(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof Xn ? function(t, e, n) {
        if (Gn(t.precondition, e)) {
            var r = Zn(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll($n(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Wn(t, e, n, r) {
    return t instanceof Jn ? function(t, e, n, r) {
        if (!Gn(t.precondition, e)) 
        // The mutation failed to apply (e.g. a document ID created with add()
        // caused a name collision).
        return n;
        var i = t.value.clone(), o = tr(t.fieldTransforms, r, e);
        return i.setAll(o), e.convertToFoundDocument(e.version, i).setHasLocalMutations(), 
        null;
        // SetMutation overwrites all fields.
        }(t, e, n, r) : t instanceof Xn ? function(t, e, n, r) {
        if (!Gn(t.precondition, e)) return n;
        var i = tr(t.fieldTransforms, r, e), o = e.data;
        return o.setAll($n(t)), o.setAll(i), e.convertToFoundDocument(e.version, o).setHasLocalMutations(), 
        null === n ? null : n.unionWith(t.fieldMask.fields).unionWith(t.fieldTransforms.map((function(t) {
            return t.field;
        })));
    }(t, e, n, r) : function(t, e, n) {
        return Gn(t.precondition, e) ? (e.convertToNoDocument(e.version).setHasLocalMutations(), 
        null) : n;
    }(t, e, n);
}
 ...
 */ function Hn(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], u = e.data.field(o.field), s = Cn(o.transform, u || null);
        null != s && (null === n && (n = Fe.empty()), n.set(o.field, s));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && ct(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Vn && e instanceof Vn || t instanceof Rn && e instanceof Rn ? ct(t.elements, e.elements, ge) : t instanceof Ln && e instanceof Ln ? ge(t._t, e._t) : t instanceof On && e instanceof On;
 ...
 */ function tr(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(u.field, An(s, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var er, nr, rr = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (nr = er || (er = {}))[nr.OK = 0] = "OK", nr[nr.CANCELLED = 1] = "CANCELLED", 
nr[nr.UNKNOWN = 2] = "UNKNOWN", nr[nr.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
nr[nr.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", nr[nr.NOT_FOUND = 5] = "NOT_FOUND", 
nr[nr.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", nr[nr.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
nr[nr.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", nr[nr.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
nr[nr.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", nr[nr.ABORTED = 10] = "ABORTED", 
nr[nr.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", nr[nr.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
nr[nr.INTERNAL = 13] = "INTERNAL", nr[nr.UNAVAILABLE = 14] = "UNAVAILABLE", nr[nr.DATA_LOSS = 15] = "DATA_LOSS";
...
var ar = /** @class */ function() {
    ...
    t.prototype.delete = function(t) {
        ...
        return Wt(this.inner);
    }, t.prototype.size = function() {
        return this.innerSize;
    }, t;
}(), cr = new Ht(mt.comparator);
...
var hr = new Ht(mt.comparator);

function fr() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = hr, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.insert(o.key, o);
    }
    return n;
...
var mr = new Ht(mt.comparator), gr = new Xt(mt.comparator);

function wr() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = gr, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var Er = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Tr.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(ft.min(), r, Ir(), lr(), wr());
    }, t;
}(), Tr = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(ne.EMPTY_BYTE_STRING, n, wr(), wr(), wr());
    }, t;
}(), Sr = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = ne.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    function t() {
        ...
        this.At = ne.EMPTY_BYTE_STRING, this.Rt = !1, 
        /**
    ...
    t.prototype.St = function() {
        ...
        })), new Tr(this.At, this.Rt, t, e, n);
    }, 
    /**
     * Resets the document changes and sets `hasPendingChanges` to false.
     */
    t.prototype.Dt = function() {
        this.bt = !1, this.Et = kr();
    ...
    /** Processes and adds the WatchTargetChange to the current set of changes. */ t.prototype.Gt = function(t) {
        ...
        this.forEachTarget(t, (function(n) {
            ...
            switch (t.state) {
              ...
              case 3 /* Current */ :
                e.jt(n) && (r.Mt(), r.Vt(t.resumeToken));
                break;
    ...
    t.prototype.zt = function(t) {
        ...
        if (r) {
            ...
            if (Ge(i)) if (0 === n) {
                ...
                // queries.
                var o = new mt(i.path);
                this.Kt(e, o, Pe.newNoDocument(o, ft.min()));
    ...
    t.prototype.Yt = function(t) {
        ...
        this.Ft.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && Ge(o.target)) {
                    ...
                    null !== e.$t.get(u) || e.Xt(i, u) || e.Kt(i, u, Pe.newNoDocument(u, t));
                }
        ...
        var i = new Er(t, n, this.Lt, this.$t, r);
        return this.$t = lr(), this.Bt = Ar(), this.Lt = new Xt(at), i;
    }, 
    /**
    ...
    t.prototype.Nt = function(t) {
        ...
        var e = this.Ft.get(t);
        return e || (e = new _r, this.Ft.set(t, e)), e;
    }, t.prototype.Zt = function(t) {
        var e = this.Bt.get(t);
        return e || (e = new Xt(at), this.Bt = this.Bt.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Wt = function(t) {
        var e = this;
        this.Ft.set(t, new _r), this.Ot.getRemoteKeysForTarget(t).forEach((function(n) {
...
function Gr(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? pt.emptyPath() : zr(e);
}
...
function Wr(t, e, n) {
    var r = Br(t, e.name), i = Lr(e.updateTime), o = new Fe({
        mapValue: {
            fields: e.fields
        }
    }), u = Pe.newFoundDocument(r, i, o);
...
function Hr(t, e) {
    ...
    if (e instanceof Jn) n = {
        update: Qr(t, e.key, e.value)
    }; else if (e instanceof rr) n = {
        delete: Ur(t, e.key)
    }; else if (e instanceof Xn) n = {
        update: Qr(t, e.key, e.data),
        updateMask: ui(e.fieldMask)
    }; else {
        if (!(e instanceof ir)) return j();
        n = {
            verify: Ur(t, e.key)
        };
    }
...
function Yr(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Kn.updateTime(Lr(t.updateTime)) : void 0 !== t.exists ? Kn.exists(t.exists) : Kn.none();
    }(e.currentDocument) : Kn.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new On; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Vn(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new Rn(i);
            } else "increment" in e ? n = new Ln(t, e.increment) : j();
    ...
    if (e.update) {
        e.update.name;
        var i = Br(t, e.update.name), o = new Fe({
            mapValue: {
        ...
        if (e.updateMask) {
            var u = function(t) {
                var e = t.fieldPaths || [];
                return new te(e.map((function(t) {
                    return yt.fromServerFormat(t);
                })));
            }(e.updateMask);
            return new Xn(i, o, u, n, r);
        }
        return new Jn(i, o, n, r);
    }
    if (e.delete) {
        var s = Br(t, e.delete);
        return new rr(s, n);
...
function Xr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Kr(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Kr(t, r.popLast()), n.structuredQuery.from = [ {
...
function $r(t) {
    var e = Gr(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        z(1 === r);
        var o = n.from[0];
    ...
    var u = [];
    n.where && (u = Zr(n.where));
    var s = [];
    n.orderBy && (s = n.orderBy.map((function(t) {
        return function(t) {
            return new rn(ri(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    n.limit && (a = function(t) {
        var e;
        return fe(e = "object" == typeof t ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
    ...
    return n.endAt && (l = function(t) {
        var e = !t.before, n = t.values || [];
        return new nn(n, e);
    }(n.endAt)), cn(e, i, s, u, a, "F" /* First */ , c, l);
}

function Zr(t) {
    return t ? void 0 !== t.unaryFilter ? [ oi(t) ] : void 0 !== t.fieldFilter ? [ ii(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Zr(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : j() : [];
...
function ii(t) {
    return We.create(ri(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function oi(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = ri(t.unaryFilter.field);
        return We.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = ri(t.unaryFilter.field);
        return We.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = ri(t.unaryFilter.field);
        return We.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = ri(t.unaryFilter.field);
 ...
 */ function ai(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = li(e)), e = ci(t.get(n), e);
    return li(e);
}
 ...
 * information.
 */ var vi = {}, yi = [ "prefixPath", "collectionGroup", "readTime", "documentId" ], mi = [ "prefixPath", "collectionGroup", "documentId" ], gi = [ "collectionGroup", "readTime", "prefixPath", "documentId" ], wi = [ "canonicalId", "targetId" ], bi = [ "targetId", "path" ], Ii = [ "path", "targetId" ], Ei = [ "collectionId", "parent" ], Ti = [ "indexId", "uid" ], Si = [ "uid", "sequenceNumber" ], Di = [ "indexId", "uid", "arrayValue", "directionalValue", "orderedDocumentKey", "documentKey" ], xi = [ "indexId", "uid", "orderedDocumentKey" ], _i = [ "userId", "collectionPath", "documentId" ], Ni = [ "userId", "collectionPath", "largestBatchId" ], Ai = [ "userId", "collectionGroup", "largestBatchId" ], ki = r(r([], r(r([], r(r([], r(r([], [ "mutationQueues", "mutations", "documentMutations", "remoteDocuments", "targets", "owner", "targetGlobal", "targetDocuments" ]), [ "clientMetadata" ])), [ "remoteDocumentGlobal" ])), [ "collectionParents" ])), [ "bundles", "namedQueries" ]), Ci = r(r([], ki), [ "documentOverlays" ]), Oi = [ "mutationQueues", "mutations", "documentMutations", "remoteDocumentsV14", "targets", "owner", "targetGlobal", "targetDocuments", "clientMetadata", "remoteDocumentGlobal", "collectionParents", "bundles", "namedQueries", "documentOverlays" ], Vi = Oi, Mi = r(r([], Vi), [ "indexConfiguration", "indexState", "indexEntries" ]), Ri = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ var Li = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Qn(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t.key) && (e = Wn(i, t, e, this.localWriteTime));
        }
        // Second, apply all user-provided mutations.
                for (var o = 0, u = this.mutations; o < u.length; o++) {
            var s = u[o];
            s.key.isEqual(t.key) && (e = Wn(s, t, e, this.localWriteTime));
        }
        return e;
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t, e) {
        ...
        // to O(n).
            ...
            var o = t.get(i.key), u = o.overlayedDocument, s = n.applyToLocalView(u, o.mutatedFields), a = zn(u, 
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = mr, o = e.mutations, u = 0; u < o.length; u++) i = i.insert(o[u].key, r[u].version);
     ...
     * time from which the server should resume sending results.
     */ , u) {
        void 0 === i && (i = ft.min()), void 0 === o && (o = ft.min()), void 0 === u && (u = ne.EMPTY_BYTE_STRING), 
...
/** Encodes a document for storage locally. */ function Ki(t, e) {
    ...
    if (e.isFoundDocument()) r.document = function(t, e) {
        return {
            ...
            updateTime: Mr(t, e.version.toTimestamp())
        };
    }(t.ne, e); else if (e.isNoDocument()) r.noDocument = {
        path: n.path.toArray(),
        readTime: ji(e.version)
    }; else {
        if (!e.isUnknownDocument()) return j();
        r.unknownDocument = {
            path: n.path.toArray(),
            version: ji(e.version)
        };
    }
    return r;
}
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Qi(t, e) {
    ...
    return new Li(e.batchId, s, n, u);
}

/** Decodes a DbTarget into TargetData */ function Wi(t) {
    var e, n, r = zi(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? zi(t.lastLimboFreeSnapshotVersion) : ft.min();
    return void 0 !== t.query.documents ? (z(1 === (n = t.query).documents.length), 
    e = yn(ln(Gr(n.documents[0])))) : e = function(t) {
        return yn($r(t));
    }(t.query), new Ui(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, ne.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Hi(t, e) {
    var n, r = ji(e.snapshotVersion), i = ji(e.lastLimboFreeSnapshotVersion);
    n = Ge(e.target) ? Jr(t.ne, e.target) : Xr(t.ne, e.target);
...
/** Encodes a DbDocumentOverlay object to an Overlay model object. */ function Ji(t, e) {
    return new qi(e.largestBatchId, Yr(t.ne, e.overlayMutation));
}
...
function $i(t, e, n, r) {
    return {
        ...
        documentKey: ai(r.documentKey.path),
 ...
 */ var no = /** @class */ function() {
    ...
    return t.se = function(e, n) {
        ...
        var n = this;
        return ro(t).get(Xi(this.userId, e)).next((function(t) {
            return t ? Ji(n.wt, t) : null;
        }));
    }, t.prototype.getOverlays = function(t, e) {
        var n = this, r = pr();
        return Ot.forEach(e, (function(e) {
        ...
        e.forEach((function(t) {
            return i.add(ai(t.getCollectionPath()));
        }));
        var o = [];
        return i.forEach((function(e) {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            o.push(ro(t).W("collectionPathOverlayIndex", i));
        })), Ot.waitFor(o);
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        var r = this, i = pr(), o = ai(e), u = IDBKeyRange.bound([ this.userId, o, n ], [ this.userId, o, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return ro(t).K("collectionPathOverlayIndex", u).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) {
                var o = n[e], u = Ji(r.wt, o);
                i.set(u.getKey(), u);
            }
            return i;
        }));
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        var i, o = this, u = pr(), s = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return ro(t).J({
        ...
        return ro(t).put(function(t, e, n) {
            var r = Xi(e, n.mutation.key);
            return r[0], {
                userId: e,
                collectionPath: r[1],
                documentId: r[2],
                ...
                overlayMutation: Hr(t.ne, n.mutation)
            };
...
/** Firestore index value writer.  */ var io = /** @class */ function() {
    function t() {}
    ...
    /** Writes an index value.  */    return t.prototype.re = function(t, e) {
        ...
        e.ae(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.ce(e, 15), e.ae(oe(t.integerValue)); else if ("doubleValue" in t) {
            var n = oe(t.doubleValue);
            isNaN(n) ? this.ce(e, 13) : (this.ce(e, 15), de(n) ? 
        ...
        e.de(ue(t.bytesValue)), this.fe(e); else if ("referenceValue" in t) this._e(t.referenceValue, e); else if ("geoPointValue" in t) {
            var i = t.geoPointValue;
            this.ce(e, 45), e.ae(i.latitude || 0), e.ae(i.longitude || 0);
        } else "mapValue" in t ? Ce(t) ? this.ce(e, Number.MAX_SAFE_INTEGER) : (this.we(t.mapValue, e), 
...
var so = /** @class */ function() {
    ...
    /** Makes a copy of the encoded bytes in this buffer.  */ t.prototype.Me = function() {
    ...
    function t() {
        this.Oe = new so, this.Fe = new ao(this.Oe), this.$e = new co(this.Oe);
    }
...
function fo(t, e) {
    ...
    return 0 !== n ? n : 0 !== (n = po(t.arrayValue, e.arrayValue)) ? n : 0 !== (n = po(t.directionalValue, e.directionalValue)) ? n : mt.comparator(t.documentKey, e.documentKey);
}
 ...
 */ var vo = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.ze.add(e), Ot.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return Ot.resolve(this.ze.getEntries(e));
        ...
        // Field indices are not supported with memory persistence.
        return Ot.resolve(null);
    }, t.prototype.getIndexType = function(t, e) {
        // Field indices are not supported with memory persistence.
        return Ot.resolve(0 /* NONE */);
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new Xt(pt.comparator), i = !r.has(n);
...
}(), go = new Uint8Array(0), wo = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return bo(t).K(r).next((function(t) {
        ...
        var n = this, r = Eo(t), i = function(t) {
            return {
                indexId: t.indexId,
        ...
        if (e.indexState) {
            ...
            return o.next((function(t) {
                u.put($i(t, n.user, e.indexState.sequenceNumber, e.indexState.offset));
            }));
        }
        return o.next();
    }, t.prototype.deleteFieldIndex = function(t, e) {
        var n = Eo(t), r = To(t), i = Io(t);
        ...
        var n = this, r = Io(t), i = !0, o = new Map;
        return Ot.forEach(this.Ye(e), (function(e) {
            ...
            if (i) {
                var t = wr(), u = [];
                return Ot.forEach(o, (function(i, o) {
                    var s;
                    ...
                    })).join(",") + " to execute ") + Be(e));
                    var a = function(t, e) {
                        var n = wt(e);
                        if (void 0 === n) return null;
                        for (var r = 0, i = je(t, n.fieldPath); r < i.length; r++) {
                            var o = i[r];
                            switch (o.op) {
                        ...
                        for (var n = new Map, r = 0, i = bt(e); r < i.length; r++) for (var o = i[r], u = 0, s = je(t, o.fieldPath); u < s.length; u++) {
                            var a = s[u];
                            switch (a.op) {
                              case "==" /* EQUAL */ :
                              case "in" /* IN */ :
                        ...
                        for (var n = [], r = !0, i = 0, o = bt(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? ze(t, u.fieldPath, t.startAt) : Qe(t, u.fieldPath, t.startAt);
                        ...
                        // endAt.
                        for (var n = [], r = !0, i = 0, o = bt(e); i < o.length; i++) {
                            var u = o[i], s = 0 /* ASCENDING */ === u.kind ? Qe(t, u.fieldPath, t.endAt) : ze(t, u.fieldPath, t.endAt);
                            n.push(s.value), r && (r = s.inclusive);
                        }
                        return new nn(n, r);
                    }(o, i), f = n.Ze(i, o, l), d = n.Ze(i, o, h), p = n.tn(i, o, c), v = n.en(i.indexId, a, f, l.inclusive, d, h.inclusive, p);
                    return Ot.forEach(v, (function(n) {
    ...
    t.prototype.en = function(t, e, n, r, i, o, u) {
        for (var s = this, a = (null != e ? e.length : 1) * Math.max(n.length, i.length), c = a / (null != e ? e.length : 1), l = [], h = function(a) {
            var h = e ? f.nn(e[a / c]) : go, d = f.sn(t, h, n[a % c], r), p = f.rn(t, h, i[a % c], o), v = u.map((function(e) {
                return s.sn(t, h, e, 
                /* inclusive= */ !0);
            }));
        ...
        return Ot.forEach(this.Ye(e), (function(e) {
            return n.Xe(t, e).next((function(t) {
                t ? 0 /* NONE */ !== r && t.fields.length < function(t) {
                    for (var e = new Xt(yt.comparator), n = !1, r = 0, i = t.filters; r < i.length; r++) {
                        var o = i[r];
    ...
    t.prototype.on = function(t, e) {
        for (var n = new lo, r = 0, i = bt(t); r < i.length; r++) {
    ...
    /** Encodes a single value to the ascending index format. */ t.prototype.nn = function(t) {
        var e = new lo;
        return io.ye.re(t, e.Be(0 /* ASCENDING */)), e.Me();
    }, 
    /**
    ...
    t.prototype.un = function(t, e) {
        var n = new lo;
        return io.ye.re(Se(this.databaseId, e), n.Be(function(t) {
            var e = bt(t);
    ...
    t.prototype.tn = function(t, e, n) {
        ...
        for (var i = 0, o = 0, u = bt(t); o < u.length; o++) for (var s = u[o], a = n[i++], c = 0, l = r; c < l.length; c++) {
            var h = l[c];
            if (this.cn(e, s.fieldPath) && xe(a)) r = this.an(r, s, a); else {
                var f = h.Be(s.kind);
                io.ye.re(a, f);
            }
        }
    ...
    /** Returns the byte representation for the provided encoders. */ t.prototype.hn = function(t) {
        for (var e = [], n = 0; n < t.length; ++n) e[n] = t[n].Me();
        return e;
    }, 
    /**
    ...
    t.prototype.an = function(t, e, n) {
        for (var i = r([], t), o = [], u = 0, s = n.arrayValue.values || []; u < s.length; u++) for (var a = s[u], c = 0, l = i; c < l.length; c++) {
            var h = l[c], f = new lo;
            f.seed(h.Me()), io.ye.re(a, f.Be(e.kind)), o.push(f);
        }
        return o;
    }, t.prototype.cn = function(t, e) {
        return !!t.filters.find((function(t) {
            return t instanceof We && t.field.isEqual(e) && ("in" /* IN */ === t.op || "not-in" /* NOT_IN */ === t.op);
        }));
    }, t.prototype.getFieldIndexes = function(t, e) {
        var n = this, r = Eo(t), i = To(t);
        return (e ? r.K("collectionGroupIndex", IDBKeyRange.bound(e, e)) : r.K()).next((function(t) {
            var e = [];
            return Ot.forEach(t, (function(t) {
                return i.get([ t.indexId, n.uid ]).next((function(n) {
                    e.push(function(t, e) {
                        var n = e ? new St(e.sequenceNumber, new _t(zi(e.readTime), new mt(hi(e.documentKey)), e.largestBatchId)) : St.empty(), r = t.fields.map((function(t) {
                            var e = t[0], n = t[1];
                            return new Et(yt.fromServerFormat(e), n);
                        }));
        ...
        // here.
                return Ot.forEach(e, (function(e, i) {
            var o = r.get(e.collectionGroup);
            return (o ? Ot.resolve(o) : n.getFieldIndexes(t, e.collectionGroup)).next((function(o) {
                return r.set(e.collectionGroup, o), Ot.forEach(o, (function(r) {
                    return n.fn(t, e, r).next((function(e) {
                        var o = n.dn(i, r);
                        return e.isEqual(o) ? Ot.resolve() : n._n(t, i, r, e, o);
                    }));
                }));
            }));
        }));
        ...
        return Io(t).delete([ r.indexId, this.uid, r.arrayValue, r.directionalValue, this.un(n, e.key), e.key.path.toArray() ]);
    }, t.prototype.fn = function(t, e, n) {
        var r = Io(t), i = new Xt(fo);
        return r.J({
            index: "documentKeyIndex",
            range: IDBKeyRange.only([ n.indexId, this.uid, this.un(n, e) ])
        }, (function(t, r) {
            i = i.add(new ho(n.indexId, e, r.arrayValue, r.directionalValue));
        })).next((function() {
            return i;
        }));
    }, 
    /** Creates the index entries for the given document. */ t.prototype.dn = function(t, e) {
        var n = new Xt(fo), r = this.on(e, t);
        if (null == r) return n;
        var i = wt(e);
        if (null != i) {
            var o = t.data.field(i.fieldPath);
            if (xe(o)) for (var u = 0, s = o.arrayValue.values || []; u < s.length; u++) {
                var a = s[u];
                n = n.add(new ho(e.indexId, t.key, this.nn(a), r));
            }
        } else n = n.add(new ho(e.indexId, t.key, go, r));
        return n;
    }, 
    /**
    ...
    t.prototype._n = function(t, e, n, r, i) {
        ...
        return function(t, e, n, r, i) {
            ...
            // `comparator`.
            for (var o = t.getIterator(), u = e.getIterator(), s = Zt(o), a = Zt(u); s || a; ) {
                var c = !1, l = !1;
                if (s && a) {
                    var h = n(s, a);
                    h < 0 ? 
                ...
                c ? (r(a), a = Zt(u)) : l ? (i(s), s = Zt(o)) : (s = Zt(o), a = Zt(u));
            }
        }(r, i, fo, (
        /* onAdd= */ function(r) {
            u.push(o.wn(t, e, n, r));
    ...
    t.prototype.createRange = function(t, e, n) {
        ...
        n = n.sort((function(t, e) {
            ...
            return !e || 0 !== fo(t, n[e - 1]);
        }));
        var r = [];
        r.push(t);
        for (var i = 0, o = n; i < o.length; i++) {
            var u = o[i], s = fo(u, t), a = fo(u, e);
            if (0 === s) 
        ...
        r.push(e);
        for (var c = [], l = 0; l < r.length; l += 2) c.push(IDBKeyRange.bound([ r[l].indexId, this.uid, r[l].arrayValue, r[l].directionalValue, go, [] ], [ r[l + 1].indexId, this.uid, r[l + 1].arrayValue, r[l + 1].directionalValue, go, [] ]));
        return c;
    }, t.prototype.getMinOffsetFromCollectionGroup = function(t, e) {
        return this.getFieldIndexes(t, e).next(So);
    }, t.prototype.getMinOffset = function(t, e) {
        var n = this;
        return Ot.mapArray(this.Ye(e), (function(e) {
            return n.Xe(t, e).next((function(t) {
                return t || j();
            }));
        })).next(So);
 ...
 */
function bo(t) {
    return Fi(t, "collectionParents");
}

/**
 * Helper to get a typed SimpleDbStore for the index entry object store.
 */ function Io(t) {
    return Fi(t, "indexEntries");
}

/**
 * Helper to get a typed SimpleDbStore for the index configuration object store.
 */ function Eo(t) {
    return Fi(t, "indexConfiguration");
}

/**
 * Helper to get a typed SimpleDbStore for the index state object store.
 */ function To(t) {
    return Fi(t, "indexState");
}
...
function So(t) {
    ...
    for (var e = t[0].indexState.offset, n = e.largestBatchId, r = 1; r < t.length; r++) {
        ...
        Nt(i, e) < 0 && (e = i), n < i.largestBatchId && (n = i.largestBatchId);
    }
    return new _t(e.readTime, e.documentKey, n);
}
...
function _o(t, e, n) {
    ...
    for (var c = [], l = 0, h = n.mutations; l < h.length; l++) {
        var f = h[l], d = pi(e, f.key.path, n.batchId);
        o.push(i.delete(d)), c.push(f.key);
    }
    return Ot.waitFor(o).next((function() {
        return c;
    }));
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ xo.DEFAULT_COLLECTION_PERCENTILE = 10, 
xo.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, xo.DEFAULT = new xo(41943040, xo.DEFAULT_COLLECTION_PERCENTILE, xo.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
xo.DISABLED = new xo(-1, 0, 0);
...
var Ao = /** @class */ function() {
    ...
    return t.se = function(e, n, r, i) {
        ...
        return u.add({}).next((function(s) {
            z("number" == typeof s);
            for (var a = new Li(s, e, n, r), c = function(t, e, n) {
            ...
            }(i.wt, i.userId, a), l = [], h = new Xt((function(t, e) {
                return at(t.canonicalString(), e.canonicalString());
            })), f = 0, d = r; f < d.length; f++) {
                var p = d[f], v = pi(i.userId, p.key.path, s);
                h = h.add(p.key.path.popLast()), l.push(u.put(c)), l.push(o.put(v, vi));
            }
            return h.forEach((function(e) {
                l.push(i.indexManager.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.gn[s] = a.keys();
            })), Ot.waitFor(l).next((function() {
                return a;
            }));
        }));
    }, t.prototype.lookupMutationBatch = function(t, e) {
        var n = this;
        return Co(t).get(e).next((function(t) {
            return t ? (z(t.userId === n.userId), Qi(n.wt, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.yn = function(t, e) {
        var n = this;
        return this.gn[e] ? Ot.resolve(this.gn[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.gn[e] = r, r;
            }
        ...
        return Co(t).J({
            ...
            e.userId === n.userId && (z(e.batchId >= r), o = Qi(n.wt, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return Co(t).K("userMutationsIndex", n).next((function(t) {
            return t.map((function(t) {
                return Qi(e.wt, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = di(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return Oo(t).J({
            range: i
        }, (function(r, i, u) {
            var s = r[0], a = r[1], c = r[2], l = hi(a);
            ...
            return Co(t).get(c).next((function(t) {
                if (!t) throw j();
                z(t.userId === n.userId), o.push(Qi(n.wt, t));
            }));
            u.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new Xt(at), i = [];
        return e.forEach((function(e) {
            var o = di(n.userId, e.path), u = IDBKeyRange.lowerBound(o), s = Oo(t).J({
                range: u
            }, (function(t, i, o) {
                var u = t[0], s = t[1], a = t[2], c = hi(s);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(s);
        })), Ot.waitFor(i).next((function() {
            return n.pn(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = di(this.userId, r), u = IDBKeyRange.lowerBound(o), s = new Xt(at);
        return Oo(t).J({
            range: u
        }, (function(t, e, o) {
            var u = t[0], a = t[1], c = t[2], l = hi(a);
        ...
        return e.forEach((function(e) {
            i.push(Co(t).get(e).next((function(t) {
                if (null === t) throw j();
                z(t.userId === n.userId), r.push(Qi(n.wt, t));
            })));
        })), Ot.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return _o(t.ee, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.In(e.batchId);
            })), Ot.forEach(r, (function(e) {
    ...
    t.prototype.In = function(t) {
        ...
        return ko(t, this.userId, e);
    }, 
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    t.prototype.Tn = function(t) {
        var e = this;
        return Vo(t).get(this.userId).next((function(t) {
            return t || {
                userId: e.userId,
 ...
 */ function ko(t, e, n) {
    var r = di(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), u = !1;
    return Oo(t).J({
        range: o,
        H: !0
    }, (function(t, n, r) {
 ...
 */ function Co(t) {
    return Fi(t, "mutations");
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Oo(t) {
    return Fi(t, "documentMutations");
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Vo(t) {
    return Fi(t, "mutationQueues");
}
 ...
 */ var Mo = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.bn(t).next((function(n) {
            var r = new Mo(n.highestTargetId);
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return Fo(t).J((function(t, n) {
            var r = Wi(n);
            e(r);
        }));
    }, t.prototype.bn = function(t) {
        return Lo(t).get("targetGlobalKey").next((function(t) {
            return z(null !== t), t;
        }));
    }, t.prototype.Pn = function(t, e) {
        return Lo(t).put("targetGlobalKey", e);
    }, t.prototype.vn = function(t, e) {
        return Fo(t).put(Hi(this.wt, e));
    }, 
    /**
    ...
    t.prototype.Vn = function(t, e) {
        ...
        var n = Be(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return Fo(t).J({
            range: r,
        ...
        // IndexedDb.
                return Ot.forEach(e, (function(e) {
            var o = ai(e.path);
            return Ot.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }, t.prototype.removeMatchingKeysForTargetId = function(t, e) {
        var n = Po(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = Po(t), i = wr();
        return r.J({
            range: n,
            H: !0
        }, (function(t, e, n) {
            var r = hi(t[1]), o = new mt(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = ai(e.path), r = IDBKeyRange.bound([ n ], [ lt(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Po(t).J({
    ...
    t.prototype.te = function(t, e) {
        return Fo(t).get(e).next((function(t) {
            return t ? Wi(t) : null;
        }));
    }, t;
}();
 ...
 */ function Lo(t) {
    return Fi(t, "targetGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function Po(t) {
    return Fi(t, "targetDocuments");
}
 ...
 */ var Uo = /** @class */ function() {
    function t(t) {
        this.Sn = t, this.buffer = new Xt(qo), this.Dn = 0;
    }
    return t.prototype.Cn = function() {
        ...
        if (this.buffer.size < this.Sn) this.buffer = this.buffer.add(e); else {
            ...
            qo(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(e) {
                    switch (e.label) {
                      ...
                      case 3:
                        return Lt(t = e.sent()) ? (U("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        return this.Mn.On(t).next((function(t) {
            return Math.floor(e / 100 * t);
        }));
    }, t.prototype.nthSequenceNumber = function(t, e) {
        var n = this;
        if (0 === e) return Ot.resolve(jt.ot);
        var r = new Uo(e);
        return this.Mn.forEachTarget(t, (function(t) {
            return r.xn(t.sequenceNumber);
        })).next((function() {
            return n.Mn.Fn(t, (function(t) {
                return r.xn(t);
            }));
        })).next((function() {
            return r.maxValue;
        ...
        Ot.resolve(Do)) : this.getCacheSize(t).next((function(r) {
    ...
    t.prototype.Un = function(t, e) {
        return function(t, e) {
            var n = !1;
            return Vo(t).Y((function(r) {
                return ko(t, r, e).next((function(t) {
                    return t && (n = !0), Ot.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (s <= e) {
                var a = n.Un(t, u).next((function(e) {
                    ...
                    return o++, r.getEntry(t, u).next((function() {
                        return r.removeEntry(u, ft.min()), Po(t).delete([ 0, ai(u.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var zo = /** @class */ function() {
    function t() {
        ...
        this.changes = new ar((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.removeEntry = function(t, e) {
        this.assertNotApplied(), this.changes.set(t, Pe.newInvalidDocument(t).setReadTime(e));
    }, 
    /**
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? Ot.resolve(n) : this.getFromCache(t, e);
    }, 
    /**
 ...
 */
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this, r = Pe.newInvalidDocument(e);
        return Jo(t).J({
            index: "documentKeyIndex",
            range: IDBKeyRange.only(Xo(e))
        }, (function(t, i) {
            r = n.Kn(e, i);
        })).next((function() {
            return r;
    ...
    t.prototype.Gn = function(t, e) {
        var n = this, r = {
            size: 0,
            document: Pe.newInvalidDocument(e)
        };
        return Jo(t).J({
            index: "documentKeyIndex",
            range: IDBKeyRange.only(Xo(e))
    ...
    t.prototype.jn = function(t, e) {
        var n = this, r = lr(), i = new Ht(mt.comparator);
        return this.Qn(t, e, (function(t, e) {
            var o = n.Kn(t, e);
            r = r.insert(t, o), i = i.insert(t, No(e));
        })).next((function() {
            return {
                documents: r,
                Wn: i
        ...
        if (e.isEmpty()) return Ot.resolve();
        var i = new Xt(Zo);
        e.forEach((function(t) {
            return i = i.add(t);
        }));
        var o = IDBKeyRange.bound(Xo(i.first()), Xo(i.last())), u = i.getIterator(), s = u.getNext();
        return Jo(t).J({
            index: "documentKeyIndex",
            range: o
        }, (function(t, e, i) {
            // Go through keys not found in cache.
            for (var o = mt.fromSegments(r(r([], e.prefixPath), [ e.collectionGroup, e.documentId ])); s && Zo(s, o) < 0; ) n(s, null), 
            s = u.getNext();
            s && s.isEqual(o) && (
            // Key found in cache.
        ...
        var r = this, i = [ e.popLast().toArray(), e.lastSegment(), Gi(n.readTime), n.documentKey.path.isEmpty() ? "" : n.documentKey.path.lastSegment() ], o = [ e.popLast().toArray(), e.lastSegment(), [ Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER ], "" ];
        return Jo(t).K(IDBKeyRange.bound(i, o, !0)).next((function(t) {
            for (var e = lr(), n = 0, i = t; n < i.length; n++) {
        ...
        var i = this, o = lr(), u = $o(e, n), s = $o(e, _t.max());
        return Jo(t).J({
        ...
        return new Ho(this, !!t && t.trackRemovals);
    }, t.prototype.getSize = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return Yo(t).get("remoteDocumentGlobalKey").next((function(t) {
            return z(!!t), t;
        }));
    }, t.prototype.qn = function(t, e) {
        return Yo(t).put("remoteDocumentGlobalKey", e);
    }, 
    /**
    ...
    t.prototype.Kn = function(t, e) {
        if (e) {
            ...
            /** Decodes a remote document from storage locally to a Document. */ function(t, e) {
                var n;
                if (e.document) n = Wr(t.ne, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
                    var r = mt.fromSegments(e.noDocument.path), i = zi(e.noDocument.readTime);
                    n = Pe.newNoDocument(r, i), e.hasCommittedMutations && n.setHasCommittedMutations();
                } else {
                    if (!e.unknownDocument) return j();
                    var o = mt.fromSegments(e.unknownDocument.path), u = zi(e.unknownDocument.version);
                    n = Pe.newUnknownDocument(o, u);
                }
        ...
        return Pe.newInvalidDocument(t);
    }, t;
}();
 ...
 */ var Ho = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new Xt((function(t, e) {
            return at(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, u) {
            ...
            if (n.push(e.zn.removeEntry(t, o, s.readTime)), u.isValidDocument()) {
                ...
                var l = Ki(e.zn.wt, u.convertToNoDocument(ft.min()));
                n.push(e.zn.addEntry(t, o, l));
            }
        })), i.forEach((function(r) {
            n.push(e.zn.indexManager.addToCollectionParentIndex(t, r));
        })), n.push(this.zn.updateMetadata(t, r)), Ot.waitFor(n);
...
function Yo(t) {
    return Fi(t, "remoteDocumentGlobal");
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Jo(t) {
    return Fi(t, "remoteDocumentsV14");
}
...
e) {
    ...
    return t.prototype.getDocument = function(t, e) {
        ...
        return this.documentOverlayCache.getOverlay(t, e).next((function(i) {
            ...
            return null !== r && Wn(r.mutation, t, te.empty(), ht.now()), t;
        }));
    }, 
    /**
    ...
    t.prototype.getDocuments = function(t, e) {
        ...
        return this.remoteDocumentCache.getEntries(t, e).next((function(e) {
            return n.getLocalViewOfDocuments(t, e, wr()).next((function() {
                return e;
            }));
        }));
    }, 
    ...
    t.prototype.getOverlayedDocuments = function(t, e) {
        ...
        return this.populateOverlays(t, r, e).next((function() {
            return n.computeViews(t, e, r, wr());
        }));
    }, 
    /**
    ...
    t.prototype.computeViews = function(t, e, n, r) {
        ...
        return e.forEach((function(t, e) {
            ...
            // change (hence overlay is undefined), but would now match.
                        r.has(e.key) && (void 0 === u || u.mutation instanceof Xn) ? i = i.insert(e.key, e) : void 0 !== u && (o.set(e.key, u.mutation.getFieldMask()), 
            Wn(u.mutation, e, u.mutation.getFieldMask(), ht.now()));
        })), this.recalculateAndSaveOverlays(t, i).next((function(t) {
            return t.forEach((function(t, e) {
                return o.set(t, e);
            })), e.forEach((function(t, e) {
                var n;
                return u.set(t, new tu(e, null !== (n = o.get(t)) && void 0 !== n ? n : null));
            })), u;
        }));
    }, t.prototype.recalculateAndSaveOverlays = function(t, e) {
        var n = this, r = yr(), i = new Ht((function(t, e) {
            return t - e;
        })), o = wr();
        return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t, e).next((function(t) {
            for (var n = function(t) {
                t.keys().forEach((function(n) {
                    var o = e.get(n);
                    if (null !== o) {
                        var u = r.get(n) || te.empty();
                        u = t.applyToLocalView(o, u), r.set(n, u);
                        var s = (i.get(t.batchId) || wr()).add(n);
            ...
            for (var u = [], s = i.getReverseIterator(), a = function() {
                var i = s.getNext(), a = i.key, c = i.value, l = vr();
                c.forEach((function(t) {
                    if (!o.has(t)) {
                        var n = zn(e.get(t), r.get(t));
 ...
 */
    ...
    t.prototype.getNextDocuments = function(t, e, n, r) {
        ...
        return this.remoteDocumentCache.getAllFromCollectionGroup(t, e, n, r).next((function(o) {
            var u = r - o.size > 0 ? i.documentOverlayCache.getOverlaysForCollectionGroup(t, e, n.largestBatchId, r - o.size) : Ot.resolve(pr()), s = -1, a = o;
            ...
            // the batch id.
                ...
                return Ot.forEach(e, (function(e, n) {
                    return s < n.largestBatchId && (s = n.largestBatchId), o.get(e) ? Ot.resolve() : i.getBaseDocument(t, e, n).next((function(t) {
                        a = a.insert(e, t);
                    }));
                })).next((function() {
                    return i.populateOverlays(t, e, o);
                })).next((function() {
                    return i.computeViews(t, a, e, wr());
                })).next((function(t) {
                    return {
                        batchId: s,
                        changes: dr(t)
        ...
        var r = this, i = e.collectionGroup, o = fr();
        return this.indexManager.getCollectionParents(t, i).next((function(u) {
            return Ot.forEach(u, (function(u) {
                var s = function(t, e) {
                    return new an(e, 
        ...
        // Query the remote documents and overlay mutations.
            ...
            t.forEach((function(t, e) {
                var n = e.getKey();
                null === r.get(n) && (r = r.insert(n, Pe.newInvalidDocument(n)));
            }));
            // Apply the overlays and match against the query.
            var n = fr();
            return r.forEach((function(r, i) {
                var o = t.get(r);
                void 0 !== o && Wn(o.mutation, i, te.empty(), ht.now()), 
                // Finally, insert the documents that still match the query
                In(e, i) && (n = n.insert(r, i));
            })), n;
        }));
    }, 
    /** Returns a base document that can be used to apply `overlay`. */ t.prototype.getBaseDocument = function(t, e, n) {
        return null === n || 1 /* Patch */ === n.mutation.type ? this.remoteDocumentCache.getEntry(t, e) : Ot.resolve(Pe.newInvalidDocument(e));
    }, t;
}(), nu = /** @class */ function() {
    function t(t) {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return Ot.resolve(this.Jn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
    ...
    function t() {
        ...
        this.overlays = new Ht(mt.comparator), this.Xn = new Map;
    }
    return t.prototype.getOverlay = function(t, e) {
        return Ot.resolve(this.overlays.get(e));
    }, t.prototype.getOverlays = function(t, e) {
        var n = this, r = pr();
        return Ot.forEach(e, (function(e) {
            return n.getOverlay(t, e).next((function(t) {
        ...
        })), this.Xn.delete(n)), Ot.resolve();
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        for (var r = pr(), i = e.length + 1, o = new mt(e.child("")), u = this.overlays.getIteratorFrom(o); u.hasNext(); ) {
        ...
        for (var i = new Ht((function(t, e) {
            ...
            if (u.getKey().getCollectionGroup() === e && u.largestBatchId > n) {
                ...
                null === s && (s = pr(), i = i.insert(u.largestBatchId, s)), s.set(u.getKey(), u);
            }
        }
        for (var a = pr(), c = i.getIterator(); c.hasNext() && (c.getNext().value.forEach((function(t, e) {
            return a.set(t, e);
        })), !(a.size() >= r)); ) ;
        return Ot.resolve(a);
        ...
        this.overlays = this.overlays.insert(n.key, new qi(e, n));
        // Create the association of this overlay to the given largestBatchId.
        var o = this.Xn.get(e);
        void 0 === o && (o = wr(), this.Xn.set(e, o)), this.Xn.set(e, o.add(n.key));
    }, t;
}(), iu = /** @class */ function() {
    function t() {
        // A set of outstanding references to a document sorted by key.
        this.Zn = new Xt(ou.ts), 
        // A set of outstanding references to a document sorted by target id.
        this.es = new Xt(ou.ns)
    ...
    t.prototype.us = function(t) {
        var e = this, n = new mt(new pt([])), r = new ou(n, t), i = new ou(n, t + 1), o = [];
        ...
        var e = new mt(new pt([])), n = new ou(e, t), r = new ou(e, t + 1), i = wr();
        return this.es.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new ou(t, 0), n = this.Zn.firstAfterOrEqual(e);
    ...
    function t(t, e) {
        ...
        this.ds = new Xt(ou.ts);
    }
    return t.prototype.checkEmpty = function(t) {
        return Ot.resolve(0 === this.mutationQueue.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.fs;
        ...
        for (var u = 0, s = r; u < s.length; u++) {
            var a = s[u];
            this.ds = this.ds.add(new ou(a.key, i)), this.indexManager.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return Ot.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return Ot.resolve(this._s(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.ws(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Ot.resolve(this.mutationQueue.length > i ? this.mutationQueue[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return Ot.resolve(0 === this.mutationQueue.length ? -1 : this.fs - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return Ot.resolve(this.mutationQueue.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new ou(e, 0), i = new ou(e, Number.POSITIVE_INFINITY), o = [];
        return this.ds.forEachInRange([ r, i ], (function(t) {
            var e = n._s(t.ls);
            o.push(e);
        })), Ot.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new Xt(at);
        return e.forEach((function(t) {
            var e = new ou(t, 0), i = new ou(t, Number.POSITIVE_INFINITY);
            n.ds.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.ls);
            }));
        })), Ot.resolve(this.gs(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new ou(new mt(i), 0), u = new Xt(at);
        ...
        var r = this.ds;
        return Ot.forEach(e.mutations, (function(i) {
            var o = new ou(i.key, e.batchId);
        ...
        var n = new ou(e, 0), r = this.ds.firstAfterOrEqual(n);
        return Ot.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this.mutationQueue.length, Ot.resolve();
    }, 
    /**
    ...
    function t(t) {
        ...
        this.docs = new Ht(mt.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return Ot.resolve(n ? n.document.mutableCopy() : Pe.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = lr();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.mutableCopy() : Pe.newInvalidDocument(t));
        })), Ot.resolve(r);
    }, t.prototype.getAllFromCollection = function(t, e, n) {
        for (var r = lr(), i = new mt(e.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var u = o.getNext(), s = u.key, a = u.value.document;
            if (!e.isPrefixOf(s.path)) break;
            s.path.length > e.length + 1 || Nt(xt(a), n) <= 0 || (r = r.insert(a.key, a.mutableCopy()));
        }
        return Ot.resolve(r);
    }, t.prototype.getAllFromCollectionGroup = function(t, e, n, r) {
        ...
        return Ot.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
...
}(zo), cu = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Ts = new ar((function(t) {
            return Be(t);
        }), Ke), 
        ...
        /**
             ...
             * IDs.
             */
        this.As = new iu, this.targetCount = 0, this.Rs = Mo.An();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return Ot.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return Ot.resolve(this.Es);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.Rs.next(), Ot.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Rs = new Mo(e), this.highestTargetId = e), t.sequenceNumber > this.Es && (this.Es = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.vn(e), this.targetCount += 1, Ot.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.vn(e), Ot.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        ...
        return this.Ts.forEach((function(u, s) {
            ...
            i++);
        })), Ot.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        return Ot.resolve(this.targetCount);
    }, t.prototype.getTargetData = function(t, e) {
        var n = this.Ts.get(e) || null;
        return Ot.resolve(n);
    }, t.prototype.addMatchingKeys = function(t, e, n) {
        return this.As.ss(e, n), Ot.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.As.os(e, n);
        ...
        return this.As.us(e), Ot.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this.As.hs(e);
        return Ot.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return Ot.resolve(this.As.containsKey(e));
    }, t;
}(), lu = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.bs = {}, this.overlays = {}, this.Ps = new jt(0), this.vs = !1, this.vs = !0, 
        this.referenceDelegate = t(this), this.Vs = new cu(this), this.indexManager = new yo, 
        this.remoteDocumentCache = new su((function(t) {
            return n.referenceDelegate.Ss(t);
        })), this.wt = new Bi(e), this.Ds = new nu(this.wt);
    }
    return t.prototype.start = function() {
        ...
        return e || (e = new ru, this.overlays[t.toKey()] = e), e;
    }, t.prototype.getMutationQueue = function(t, e) {
        var n = this.bs[t.toKey()];
        return n || (n = new uu(e, this.referenceDelegate), this.bs[t.toKey()] = n), n;
        ...
        return Ot.or(Object.values(this.bs).map((function(n) {
            return function() {
    ...
    return t.Os = function(e) {
        ...
        return this.ks.addReference(n, e), this.Fs.delete(n.toString()), Ot.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.ks.removeReference(n, e), this.Fs.add(n.toString()), Ot.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.Fs.add(e.toString()), Ot.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return Ot.forEach(this.Fs, (function(r) {
            var i = mt.fromPath(r);
            return e.$s(t, i).next((function(t) {
                t || n.removeEntry(i, ft.min());
            }));
        })).next((function() {
            return e.Ms = null, n.apply(t);
        }));
    }, t.prototype.updateLimboDocument = function(t, e) {
        var n = this;
        ...
        var n = this;
        return Ot.or([ function() {
            return Ot.resolve(n.ks.containsKey(e));
        }, function() {
     ...
     */    return t.prototype.M = function(t, e, n, r) {
        var i = this, o = new Vt("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
     ...
     */
        ...
        u = u.next((function() {
            ...
            !function(t) {
                ...
                e.createIndex("collectionPathOverlayIndex", Ni, {
                    unique: !1
            ...
            return function(t) {
                ...
                e.createIndex("documentKeyIndex", mi), e.createIndex("collectionGroupIndex", gi);
            }(t);
        })).next((function() {
            return i.Gs(t, o);
        })).next((function() {
            ...
            return function(t) {
                t.createObjectStore("indexConfiguration", {
                    ...
                    keyPath: Di
                }).createIndex("documentKeyIndex", xi, {
                    unique: !1
                });
            }(t);
        }))), u;
        ...
        return n.K().next((function(n) {
            return Ot.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.K("userMutationsIndex", i).next((function(r) {
                    return Ot.forEach(r, (function(r) {
                        z(r.userId === n.userId);
                        var i = Qi(e.wt, r);
                        return _o(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.Us = function(t) {
        ...
        return t.store("targetGlobal").get("targetGlobalKey").next((function(t) {
            ...
            return n.J((function(n, i) {
                ...
                r.push(e.get(u).next((function(n) {
                    return n ? Ot.resolve() : function(n) {
                        return e.put({
                            targetId: 0,
                            path: ai(n),
        ...
        var n = e.store("collectionParents"), r = new mo, i = function(t) {
            if (r.add(t)) {
        ...
        var n = this, r = e.store("mutations"), i = Wo(this.wt), o = new lu(fu.Os, this.wt.ne);
        return r.K().next((function(t) {
            var r = new Map;
            return t.forEach((function(t) {
                var e, i = null !== (e = r.get(t.userId)) && void 0 !== e ? e : wr();
                Qi(n.wt, t).keys().forEach((function(t) {
                    return i = i.add(t);
                })), r.set(t.userId, i);
            })), Ot.forEach(r, (function(t, r) {
                var u = new R(r), s = no.se(n.wt, u), a = o.getIndexManager(u), c = Ao.se(u, n.wt, a, o.referenceDelegate);
                return new eu(i, c, s, a).recalculateAndSaveOverlaysForDocumentKeys(new Ri(e, jt.ot), t).next();
            }));
        }));
    }, t;
}();
...
var vu = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", yu = /** @class */ function() {
    function t(
    /**
    ...
    l, h) {
        ...
        this.referenceDelegate = new Go(this, i), this.ei = n + "main", this.wt = new Bi(a), 
        this.ni = new Mt(this.ei, this.Hs, new du(this.wt)), this.Vs = new Ro(this.referenceDelegate, this.wt), 
        this.remoteDocumentCache = Wo(this.wt), this.Ds = new Zi, this.window && this.window.localStorage ? this.si = this.window.localStorage : (this.si = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new Y(H.FAILED_PRECONDITION, vu);
    ...
    t.prototype.ii = function() {
        ...
        var e = this;
        return mu(t).get("owner").next((function(t) {
            return Ot.resolve(e.di(t));
        }));
    }, t.prototype._i = function(t) {
        return gu(t).delete(this.clientId);
    }, 
    /**
    ...
    t.prototype.hi = function(t) {
        var e = this;
        return this.zs ? Ot.resolve(!0) : mu(t).get("owner").next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || gu(t).K().next((function(t) {
    ...
    t.prototype.Ri = function() {
        ...
        return Ao.se(t, this.wt, e, this.referenceDelegate);
    }, t.prototype.getTargetCache = function() {
        return this.Vs;
    }, t.prototype.getRemoteDocumentCache = function() {
        return this.remoteDocumentCache;
    }, t.prototype.getIndexManager = function(t) {
        return new wo(t, this.wt.ne.databaseId);
    }, t.prototype.getDocumentOverlayCache = function(t) {
        return no.se(this.wt, t);
    }, t.prototype.getBundleCache = function() {
        return this.Ds;
    }, t.prototype.runTransaction = function(t, e, n) {
        var r = this;
        U("IndexedDbPersistence", "Starting transaction:", t);
        var i, o, u = "readonly" === e ? "readonly" : "readwrite", s = 15 === (i = this.Hs) ? Mi : 14 === i ? Vi : 13 === i ? Oi : 12 === i ? Ci : 11 === i ? ki : void j();
        /** Returns the object stores for the provided schema. */        
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.ni.runTransaction(t, u, s, (function(i) {
            return o = new Ri(i, r.Ps ? r.Ps.next() : jt.ot), "readwrite-primary" === e ? r.ai(o).next((function(t) {
                return !!t || r.hi(o);
            })).next((function(e) {
                if (!e) throw B("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.js.enqueueRetryable((function() {
                    return r.ti(!1);
                })), new Y(H.FAILED_PRECONDITION, At);
                return n(o);
            })).next((function(t) {
    ...
    t.prototype.bi = function(t) {
        var e = this;
        return mu(t).get("owner").next((function(t) {
            if (null !== t && e.mi(t.leaseTimestampMs, 5e3) && !e.pi(t.ownerId) && !e.di(t) && !(e.zs || e.allowTabSynchronization && t.allowTabSynchronization)) throw new Y(H.FAILED_PRECONDITION, vu);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.li = function(t) {
        ...
        return n.get("owner").next((function(t) {
            return e.di(t) ? (U("IndexedDbPersistence", "Releasing primary lease."), n.delete("owner")) : Ot.resolve();
        }));
    }, 
...
var bu = /** @class */ function() {
    ...
    return t.Vi = function(e, n) {
        for (var r = wr(), i = wr(), o = 0, u = n.docChanges; o < u.length; o++) {
            var s = u[o];
            switch (s.type) {
              case 0 /* Added */ :
                r = r.add(s.doc.key);
    ...
    t.prototype.Ci = function(t, e) {
        ...
        return this.indexManager.getIndexType(t, r).next((function(i) {
            ...
            e = mn(e, null, "F" /* First */), r = yn(e)), n.indexManager.getDocumentsMatchingTarget(t, r).next((function(i) {
                var o = wr.apply(void 0, i);
                return n.Di.getDocuments(t, o).next((function(i) {
                    return n.indexManager.getMinOffset(t, r).next((function(r) {
                        var u = n.ki(e, i);
                        return n.Mi(e, u, o, r.readTime) ? n.Ci(t, mn(e, null, "F" /* First */)) : n.Oi(t, u, e, r);
                    }));
                }));
            })));
        }));
    ...
    t.prototype.xi = function(t, e, n, r) {
        var i = this;
        return hn(e) || r.isEqual(ft.min()) ? this.Ni(t, e) : this.Di.getDocuments(t, n).next((function(o) {
            var u = i.ki(e, o);
            return i.Mi(e, u, n, r) ? i.Ni(t, e) : (P() <= h.DEBUG && U("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), bn(e)), 
            i.Oi(t, u, e, Dt(r, -1)));
        }));
    ...
    t.prototype.Mi = function(t, e, n, r) {
        ...
        return P() <= h.DEBUG && U("QueryEngine", "Using full collection scan to execute query:", bn(e)), 
        this.Di.getDocumentsMatchingQuery(t, e, _t.min());
    }, 
    /**
    ...
    return t.prototype.qi = function(t) {
        ...
        this.mutationQueue = this.persistence.getMutationQueue(t, this.indexManager), this.localDocuments = new eu(this.Ui, this.mutationQueue, this.documentOverlayCache, this.indexManager), 
 ...
 */ function Du(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), u = Ot.resolve();
            ...
            return n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t, function(t) {
                for (var e = wr(), n = 0; n < t.mutationResults.length; ++n) t.mutationResults[n].transformResults.length > 0 && (e = e.add(t.batch.mutations[n].key));
                return e;
            }(e));
        })).next((function() {
 ...
 */ function _u(t, e) {
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.targetChanges.forEach((function(o, s) {
            ...
            if (a) {
                ...
                e.targetMismatches.has(s) ? c = c.withResumeToken(ne.EMPTY_BYTE_STRING, ft.min()).withLastLimboFreeSnapshotVersion(ft.min()) : o.resumeToken.approximateByteSize() > 0 && (c = c.withResumeToken(o.resumeToken, r)), 
                i = i.insert(s, c), 
     ...
     */
        ...
        u.push(Nu(t, o, e.documentUpdates).next((function(t) {
            s = t.Gi, a = t.Qi;
        }))), !r.isEqual(ft.min())) {
        ...
        return Ot.waitFor(u).next((function() {
            return o.apply(t);
        })).next((function() {
 ...
 */ function ku(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Vs.getTargetData(t, e).next((function(i) {
            ...
            r = i, Ot.resolve(r)) : n.Vs.allocateTargetId(t).next((function(i) {
                return r = new Ui(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.Vs.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
 ...
 */ function Ou(t, e, n) {
    var r = W(t), i = ft.min(), o = wr();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = r.Bi.get(n);
            return void 0 !== i ? Ot.resolve(r.$i.get(i)) : r.Vs.getTargetData(e, n);
        }(r, t, yn(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Vs.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.Fi.getDocumentsMatchingQuery(t, e, n ? i : ft.min(), n ? o : wr());
        })).next((function(t) {
            return Ru(r, En(e), t), {
                documents: t,
                ji: o
...
function Mu(t, e) {
    ...
    // TODO(indexing): Consider removing the default value.
        ...
        return n.Ui.getAllFromCollectionGroup(t, e, Dt(r, -1), 
 ...
 */ function Fu(t, r, i, o) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                for (e = W(t), u = wr(), s = lr(), a = 0, c = i; a < c.length; a++) l = c[a], h = r.Wi(l.metadata.name), 
                l.document && (u = u.add(h)), (f = r.zi(l)).setReadTime(r.Hi(l.metadata.readTime)), 
                s = s.insert(h, f);
                return d = e.Ui.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , ku(e, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return yn(ln(pt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = n.sent(), [ 2 /*return*/ , e.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return Nu(t, d, s).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(n) {
 ...
 */ function Lu(t, r, i) {
    return void 0 === i && (i = wr()), e(this, void 0, void 0, (function() {
        var e, o;
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , ku(t, yn(Yi(r.bundledQuery))) ];
              ...
              case 1:
                return e = n.sent(), [ 2 /*return*/ , (o = W(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // Update existing target data because the query from the bundle is newer.
                                        var u = e.withResumeToken(ne.EMPTY_BYTE_STRING, n);
...
/** Assembles the key for a client state in WebStorage */ function Pu(t, e) {
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function qu(t, e, n) {
...
var Bu = /** @class */ function() {
    ...
    return t.Ji = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = Ir(), u = 0; i && u < r.activeTargetIds.length; ++u) i = pe(r.activeTargetIds[u]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.sr = new Ht(at), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.rr = Pu(this.persistenceKey, this.tr), 
        this.ur = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.sr = this.sr.insert(this.tr, new zu), this.cr = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.V = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.tr && (o = this.getItem(Pu(this.persistenceKey, i))) && (u = Gu.Ji(i, o)) && (this.sr = this.sr.insert(u.clientId, u));
                        ...
                        switch (n.label) {
                          ...
                          case 4:
                            return i.key !== this.ur ? [ 3 /*break*/ , 5 ] : (s = function(t) {
                                ...
                                return e;
                            }(i.newValue), s !== jt.ot && this.sequenceNumberHandler(s), [ 3 /*break*/ , 7 ]);
        ...
        var r = new Bu(this.currentUser, t, e, n), i = qu(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Yi());
    }, t.prototype.pr = function(t) {
        var e = qu(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = Uu(this.persistenceKey, t), i = new Ku(t, e, n);
        this.setItem(r, i.Yi());
    ...
    t.prototype.wr = function(t) {
        ...
        return o.forEach((function(t) {
            ...
            o.has(t) || s.push(t);
        })), this.syncEngine.Or(u, s).then((function() {
            n.sr = r;
        }));
    ...
    function t() {
        this.Fr = new zu, this.$r = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.Fr = new zu, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.co = function(t, e, n, r) {
        return new Promise((function(i, o) {
            var u = new D;
            u.listenOnce(x.COMPLETE, (function() {
                try {
        ...
        var a = i.createWebChannel(s, u), c = !1, l = !1, h = new Xu({
            jr: function(t) {
 ...
 */
        ...
        })), f(o, O.STAT_EVENT, (function(t) {
            t.stat === V.PROXY ? U("Connection", "Detected buffering proxy") : t.stat === V.NOPROXY && U("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
 ...
 * limitations under the License.
 */ function es(t) {
    return new Vr(t, /* useProto3Json= */ !0);
}
 ...
 */ var ns = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o, u, s) {
        ...
        /**
             ...
             * close.
             */
        this.Po = 0, this.vo = null, this.Vo = null, this.stream = null, this.So = new ns(t, e)
        /**
    ...
    /** Sends a message to the underlying stream. */ t.prototype.Oo = function(t) {
        this.Fo(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype.Mo = function() {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.dt ? (z(void 0 === e || "string" == typeof e), ne.fromBase64String(e || "")) : (z(void 0 === e || e instanceof Uint8Array), 
                    ne.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), u = e.targetChange.cause, s = u && function(t) {
                    var e = void 0 === t.code ? H.UNKNOWN : sr(t.code);
                    return new Y(e, t.message || "");
                }(u);
                n = new xr(r, i, o, s || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = Br(t, a.document.name), l = Lr(a.document.updateTime), h = new Fe({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), f = Pe.newFoundDocument(c, l, h), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new Sr(d, p, f.key, f);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var v = e.documentDelete;
                v.document;
                var y = Br(t, v.document), m = v.readTime ? Lr(v.readTime) : ft.min(), g = Pe.newNoDocument(y, m), w = v.removedTargetIds || [];
                n = new Sr([], w, g.key, g);
                ...
                var T = e.filter;
                T.targetId;
                var S = T.count || 0, D = new or(S), x = T.targetId;
                n = new Dr(x, D);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? ft.min() : e.readTime ? Lr(e.readTime) : ft.min();
        }(t);
    ...
    n.prototype.Qo = function(t) {
        var e = {};
        e.database = jr(this.wt), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = Ge(r) ? {
                documents: Jr(t, r)
            } : {
                query: Xr(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Rr(t, e.resumeToken) : e.snapshotVersion.compareTo(ft.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = Mr(t, e.snapshotVersion.toTimestamp())), n;
        }(this.wt, t);
        var n = function(t, e) {
            var n = function(t, e) {
                switch (e) {
    ...
    n.prototype.jo = function(t) {
        var e = {};
        e.database = jr(this.wt), e.removeTarget = t, this.Oo(e);
    }, n;
}(rs), os = /** @class */ function(e) {
    function n(t, n, r, i, o, u) {
        var s = this;
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (z(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? Lr(t.updateTime) : Lr(e);
                        ...
                        n = Lr(e)), new Bn(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = Lr(t.commitTime);
    ...
    n.prototype.Xo = function() {
        ...
        var t = {};
        t.database = jr(this.wt), this.Oo(t);
    }, 
        ...
        i.enqueueAndForget((function() {
            return e(s, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return ms(this) ? (U("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return e(this, void 0, void 0, (function() {
                                var e;
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).lu.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , ls(e) ];
 ...
 */ function fs(t, e) {
    var n = W(t), r = Vs(n);
    n.hu.delete(e), r.Co() && ps(n, e), 0 === n.hu.size && (r.Co() ? r.ko() : ms(n) && 
...
function ys(t) {
    return ms(t) && !Vs(t).Do() && t.hu.size > 0;
}
...
function Is(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t._u.set("Online" /* Online */), !(r instanceof xr && 2 /* Removed */ === r.state && r.cause)) 
              ...
              case 6:
                if (r instanceof Sr ? t.wu.Ut(r) : r instanceof Dr ? t.wu.zt(r) : t.wu.Gt(r), i.isEqual(ft.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , xu(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.hu.set(e, n.withResumeToken(ne.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new Ui(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            ds(t, r);
                        }
              ...
              case 11:
                return U("RemoteStore", "Failed to raise snapshot:", s = a.sent()), [ 4 /*yield*/ , Es(t, s) ];
        ...
        return n(this, (function(u) {
            switch (u.label) {
              case 0:
                ...
                return t.lu.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , ls(t) ];
                    ...
                    return e(o, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.lu.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , cs(t) ];
...
function Ss(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = W(t), r = Ms(e), i = e.au.length > 0 ? e.au[e.au.length - 1].batchId : -1, n.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 4:
                return u = n.sent(), [ 4 /*yield*/ , Es(e, u) ];
...
function Ds(t) {
    return ms(t) && !Ms(t).Do() && t.au.length > 0;
}
...
function Ns(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            ...
            for (e = Ms(t), r = 0, i = t.au; r < i.length; r++) o = i[r], e.Ho(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function As(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = t.au.shift(), o = Pi.from(e, r, i), [ 4 /*yield*/ , Ts(t, (function() {
...
function ks(t, r) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(i) {
            switch (i.label) {
              case 0:
                return r && Ms(t).zo ? [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return ur(i = r.code) && i !== H.ABORTED ? (e = t.au.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                Ms(t).No(), [ 4 /*yield*/ , Ts(t, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                e.lu.add(3 /* CredentialChange */), [ 4 /*yield*/ , ls(e) ];
              ...
              case 2:
                return n.sent(), e.lu.delete(3 /* CredentialChange */), [ 4 /*yield*/ , cs(e) ];
 ...
 */ function Os(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = W(t), r ? (e.lu.delete(2 /* IsSecondary */), [ 4 /*yield*/ , cs(e) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return n.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return r ? [ 3 /*break*/ , 4 ] : (e.lu.add(2 /* IsSecondary */), [ 4 /*yield*/ , ls(e) ]);
 ...
 */ function Vs(t) {
    ...
    t.mu = function(t, e, n) {
        var r = W(t);
        return r.tu(), new is(e, r.bo, r.authCredentials, r.appCheckCredentials, r.wt, n);
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.mu.No(), ys(t) ? vs(t) : t._u.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.mu.stop() ];

                  case 2:
                    e.sent(), gs(t), e.label = 3;
...
function Ms(t) {
    ...
    t.gu = function(t, e, n) {
        var r = W(t);
        return r.tu(), new os(e, r.bo, r.authCredentials, r.appCheckCredentials, r.wt, n);
    }(t.datastore, t.asyncQueue, {
        zr: _s.bind(null, t),
        Jr: ks.bind(null, t),
        Yo: Ns.bind(null, t),
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.gu.No(), [ 4 /*yield*/ , Ss(t) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function Fs(t, e) {
    if (B("AsyncQueue", e + ": " + t), Lt(t)) return new Y(H.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Ls = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = fr(), this.sortedSet = new Ht(this.comparator)
        /**
    ...
    this.queries = new ar((function(t) {
        return wn(t);
    }), gn), this.onlineState = "Unknown" /* Unknown */ , this.Tu = new Set;
};
 ...
 */ function Ks(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                if (e = W(t), i = r.query, o = !1, (u = e.queries.get(i)) || (o = !0, u = new Us), 
                !o) return [ 3 /*break*/ , 4 ];
                n.label = 1;
              ...
              case 3:
                return a = n.sent(), c = Fs(a, "Initialization of query '" + bn(r.query) + "' failed"), 
                [ 2 /*return*/ , void r.onError(c) ];

              case 4:
                return e.queries.set(i, u), u.listeners.push(r), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                r.Eu(e.onlineState), u.Iu && r.Au(u.Iu) && Qs(e), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Ws = /** @class */ function() {
    ...
    return t.prototype.Au = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new qs(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Eu = function(t) {
        ...
        t = qs.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.bu = !0, 
        this.Ru.next(t);
    }, t;
}(), Hs = /** @class */ function() {
    function t(t, 
     ...
     */
    t.prototype.zi = function(t) {
        return t.metadata.exists ? Wr(this.wt, t.document, !1) : Pe.newNoDocument(this.Wi(t.metadata.name), this.Hi(t.metadata.readTime));
    }, t.prototype.Hi = function(t) {
        return Lr(t);
    }, t;
}(), Js = /** @class */ function() {
    function t(t, e, n) {
        ...
        this.collectionGroups = new Set, this.progress = Xs(t)
        /**
    ...
    t.prototype.complete = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , Fu(this.localStore, new Ys(this.wt), this.documents, this.xu.id) ];

                  case 1:
                    t = n.sent(), e = this.ku(this.documents), r = 0, i = this.queries, n.label = 2;

                  case 2:
                    return r < i.length ? (o = i[r], [ 4 /*yield*/ , Lu(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
 ...
 */ var $s = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = wr(), this.Lu = Tn(t), this.Uu = new Ls(this.Lu);
    }
    ...
    t.prototype.Ku = function(t, e) {
        var n = this, r = e ? e.Gu : new Ps, i = e ? e.Uu : this.Uu, o = e ? e.mutatedKeys : this.mutatedKeys, u = i, s = !1, a = "F" /* First */ === this.query.limitType && i.size === this.query.limit ? i.last() : null, c = "L" /* Last */ === this.query.limitType && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var l = i.get(t), h = In(n.query, e) ? e : null, f = !!l && n.mutatedKeys.has(l.key), d = !!h && (h.hasLocalMutations || 
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.$u = s, 0 !== o.length || a ? {
            snapshot: new qs(this.query, t.Uu, i, o, t.mutatedKeys, 0 /* Local */ === s, a, 
            /* excludesMetadataChanges= */ !1),
            zu: u
        } : {
            zu: u
    ...
    t.prototype.ju = function(t) {
        ...
        // updating many documents.
                var e = this.Bu;
        this.Bu = wr(), this.Uu.forEach((function(e) {
            t.Hu(e.key) && (t.Bu = t.Bu.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Bu.has(e) || n.push(new Zs(e));
        })), this.Bu.forEach((function(t) {
            e.has(t) || n.push(new $s(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.Yu = function() {
        return qs.fromInitialDocuments(this.query, this.Uu, this.mutatedKeys, 0 /* Local */ === this.$u);
    }, t;
}(), ea = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.Zu = {}, this.tc = new ar((function(t) {
            return wn(t);
        }), gn), this.ec = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.sc = new Ht(mt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.ic = new Map, this.rc = new iu, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.oc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.uc = new Map, this.cc = Mo.Rn(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , ku(e.localStore, yn(r)) ];

              case 2:
                return s = n.sent(), e.isPrimaryClient && hs(e.remoteStore, s), a = e.sharedClientState.addLocalQueryTarget(s.targetId), 
                i = s.targetId, [ 4 /*yield*/ , oa(e, r, i, "current" === a) ];
                    ...
                    return function(t, r, i, o) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = r.view.Ku(i), e.Mi ? [ 4 /*yield*/ , Ou(t.localStore, r.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, u), [ 2 /*return*/ , (ga(t, r.targetId, s.zu), 
                                    s.snapshot) ];
                                }
                            }));
                        }));
                    }(t, r, i, o);
                }, [ 4 /*yield*/ , Ou(t.localStore, r, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return u = f.sent(), s = new ta(r, u.ji), a = s.Ku(u.documents), c = Tr.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                l = s.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), ga(t, i, l.zu), h = new ea(r, i, s), 
...
/** Stops listening to the query. */ function ua(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o;
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                /*keepPersistedTargetData=*/ !1).then((function() {
                    e.sharedClientState.clearQueryState(i.targetId), fs(e.remoteStore, i.targetId), 
                    ya(e, i.targetId);
                })).catch(Ct) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return ya(e, i.targetId), [ 4 /*yield*/ , Cu(e.localStore, i.targetId, 
            ...
            switch (n.label) {
                    ...
                    return i.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        ...
                        return i.Ui.getEntries(t, u).next((function(t) {
                            ...
                            var u = [], s = 0, a = e; s < a.length; s++) {
                                var c = a[s], l = Hn(c, n.get(c.key).overlayedDocument);
                                null != l && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                u.push(new Xn(c.key, l, Le(l.value.mapValue), Kn.exists(!0)));
                            }
              ...
              case 2:
                return o = n.sent(), e.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new Ht(at)), r = r.insert(e, n), t.oc[t.currentUser.toKey()] = r;
                }(e, o.batchId, i), [ 4 /*yield*/ , Ia(e, o.changes) ];

              case 3:
                return n.sent(), [ 4 /*yield*/ , Ss(e.remoteStore) ];

              case 4:
                return n.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return u = n.sent(), s = Fs(u, "Failed to persist write"), i.reject(s), [ 3 /*break*/ , 6 ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , _u(e.localStore, r) ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                s = (s = new Ht(mt.comparator)).insert(u, Pe.newNoDocument(u, ft.min())), a = wr().add(u), 
                c = new Er(ft.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Xt(at), s, a), [ 4 /*yield*/ , aa(e, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                e.sc = e.sc.remove(u), e.ic.delete(r), ba(e), [ 3 /*break*/ , 4 ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Du(e.localStore, r) ];
              ...
              case 2:
                ...
                va(e, i, /*error=*/ null), pa(e, i), e.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , Ia(e, o) ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 2:
                ...
                // listen events.
                va(e, r, i), pa(e, r), e.sharedClientState.updateMutationState(r, "rejected", i), 
                [ 4 /*yield*/ , Ia(e, o) ];
 ...
 */ function da(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ms((e = W(t)).remoteStore) || U("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                n.label = 1;
              ...
              case 3:
                return u = n.sent(), s = Fs(u, "Initialization of waitForPendingWrites() operation failed"), 
...
function ma(t, e) {
    ...
    var n = t.sc.get(e);
    null !== n && (fs(t.remoteStore, n), t.sc = t.sc.remove(e), t.ic.delete(n), ba(t));
}

function ga(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof $s ? (t.rc.addReference(o.key, e), wa(t, o)) : o instanceof Zs ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function ba(t) {
    for (;t.nc.size > 0 && t.sc.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.ic.set(r, new na(n)), t.sc = t.sc.insert(n, r), hs(t.remoteStore, new Ui(yn(ln(n.path)), r, 2 /* LimboResolution */ , jt.ot));
    }
}
                            ...
                            switch (n.label) {
                              ...
                              case 1:
                                return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , e.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Ot.forEach(r, (function(n) {
                                        return Ot.forEach(n.Pi, (function(r) {
                                            return e.persistence.referenceDelegate.addReference(t, n.targetId, r);
                                        })).next((function() {
                                            return Ot.forEach(n.vi, (function(r) {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                ...
                e.sharedClientState.handleUserChange(r, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , Ia(e, i.Ki) ];
...
function Ta(t, e) {
    ...
    if (r && r.Xu) return wr().add(r.key);
    var i = wr(), o = n.ec.get(e);
    if (!o) return i;
 ...
 */ function Sa(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Ou((e = W(t)).localStore, r.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = n.sent(), o = r.view.Ju(i), [ 2 /*return*/ , (e.isPrimaryClient && ga(e, r.targetId, o.zu), 
                o) ];
            }
        }));
    }));
...
function Da(t, r) {
    return e(this, void 0, void 0, (function() {
        var e;
        return n(this, (function(n) {
            return [ 2 /*return*/ , Mu((e = W(t)).localStore, r).then((function(t) {
                return Ia(e, t);
            })) ];
        }));
    }));
        ...
        return n(this, (function(n) {
            switch (n.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.yn(t, e).next((function(e) {
                            return e ? n.localDocuments.getDocuments(t, e) : Ot.resolve(null);
                        }));
                    }));
                }((e = W(t)).localStore, r) ];

              case 1:
                return null === (u = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , Ss(e.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                va(e, r, o || null), pa(e, r), function(t, e) {
                    W(W(t).mutationQueue).In(e);
                }(e.localStore, r)) : j(), n.label = 4;

              case 4:
                return [ 4 /*yield*/ , Ia(e, u) ];
...
function _a(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return Va(e = W(t)), Ma(e), !0 !== r || !0 === e.ac ? [ 3 /*break*/ , 3 ] : (i = e.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , Na(e, i.toArray()) ]);

              case 1:
                return o = n.sent(), e.ac = !0, [ 4 /*yield*/ , Os(e.remoteStore, !0) ];

              case 2:
                for (n.sent(), u = 0, s = o; u < s.length; u++) a = s[u], hs(e.remoteStore, a);
                return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                ...
                e.ec.forEach((function(t, n) {
                    e.sharedClientState.isLocalQueryTarget(n) ? c.push(n) : l = l.then((function() {
                        return ya(e, n), Cu(e.localStore, n, 
                        /*keepPersistedTargetData=*/ !0);
                    })), fs(e.remoteStore, n);
                })), [ 4 /*yield*/ , l ]);

              case 4:
                return n.sent(), [ 4 /*yield*/ , Na(e, c) ];
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.ic.forEach((function(t, n) {
                        fs(e.remoteStore, n);
                    })), e.rc.cs(), e.ic = new Map, e.sc = new Ht(mt.comparator);
                }(e), e.ac = !1, [ 4 /*yield*/ , Os(e.remoteStore, !1) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return u < s.length ? (a = s[u], c = void 0, (l = e.ec.get(a)) && 0 !== l.length ? [ 4 /*yield*/ , ku(e.localStore, yn(l[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return h < f.length ? (d = f[h], p = e.tc.get(d), [ 4 /*yield*/ , Sa(e, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , Vu(e.localStore, a) ];

              case 8:
                return y = n.sent(), [ 4 /*yield*/ , ku(e.localStore, y) ];

              case 9:
                return c = n.sent(), [ 4 /*yield*/ , oa(e, Aa(y), a, 
                /*current=*/ !1) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , Mu(e.localStore, En(u[0])) ];

              case 2:
                return s = n.sent(), a = Er.createSynthesizedRemoteEventForCurrentChange(r, "current" === i), 
                [ 4 /*yield*/ , Ia(e, s, a) ];
              ...
              case 5:
                return n.sent(), ya(e, r, o), [ 3 /*break*/ , 7 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Oa(t, r, i) {
    return e(this, void 0, void 0, (function() {
        var e, o, u, s, a, c, l, h, f, d;
        return n(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(e = Va(t)).ac) return [ 3 /*break*/ , 10 ];
                o = 0, u = r, p.label = 1;

              case 1:
                return o < u.length ? (s = u[o], e.ec.has(s) ? (
                // A target might have been added in a previous attempt
                U("SyncEngine", "Adding an already active target " + s), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Vu(e.localStore, s) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , ku(e.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , oa(e, Aa(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), hs(e.remoteStore, c), p.label = 5;
              ...
              case 6:
                l = function(t) {
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e.ec.has(t) ? [ 4 /*yield*/ , Cu(e.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                fs(e.remoteStore, t), ya(e, t);
                            })).catch(Ct) ] : [ 3 /*break*/ , 2 ];
...
function Va(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = aa.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Ta.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = la.bind(null, e), e.Zu.Go = js.bind(null, e.eventManager), 
    e.Zu.lc = zs.bind(null, e.eventManager), e;
}

function Ma(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = ha.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = fa.bind(null, e), 
    e
    /**
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 4:
                    return i._updateProgress(Xs(e)), o = new Js(e, t.localStore, r.wt), [ 4 /*yield*/ , r.fc() ];
                  ...
                  case 11:
                    return a = n.sent(), [ 4 /*yield*/ , Ia(t, a.Ou, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 13:
                    return [ 2 /*return*/ , (
                    // Save metadata, so loading the same bundle will skip.
                    n.sent(), i._completeWith(a.progress), Promise.resolve(a.Mu)) ];
...
var Fa = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.wt = es(t.databaseInfo.databaseId), this.sharedClientState = this.dc(t), 
        ...
        return Tu(this.persistence, new Iu, t.initialUser, this.wt);
    }, t.prototype._c = function(t) {
        return new lu(fu.Os, this.wt);
    ...
    return t(i, r), i.prototype.initialize = function(t) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    return n.sent(), [ 4 /*yield*/ , Ma(this.yc.syncEngine) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return n.sent(), [ 4 /*yield*/ , Ss(this.yc.remoteStore) ];
        ...
        return new Bo(n, t.asyncQueue, e);
    }, i.prototype.gc = function(t, e) {
        var n = new Gt(e, this.persistence);
        return new Kt(t.asyncQueue, n);
    }, i.prototype._c = function(t) {
        var e = wu(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? xo.withCacheSize(this.cacheSizeBytes) : xo.DEFAULT;
        return new yu(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Zu(), ts(), this.wt, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.dc = function(t) {
        return new Wu;
    }, i;
}(Fa), Pa = /** @class */ function(r) {
    function i(t, e) {
        var n = this;
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(u) {
                switch (u.label) {
                  ...
                  case 1:
                    return u.sent(), i = this.yc.syncEngine, this.sharedClientState instanceof Qu ? (this.sharedClientState.syncEngine = {
                        kr: xa.bind(null, i),
                        Mr: Ca.bind(null, i),
                        Or: Oa.bind(null, i),
                        Ri: ka.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.ci((function(t) {
                        return e(o, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , _a(this.yc.syncEngine, t) ];
        ...
        var e = Zu();
        if (!Qu.V(e)) throw new Y(H.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = wu(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Qu(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(La), qa = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, r) {
                ...
                switch (n.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return ca(e.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = Ea.bind(null, this.syncEngine), 
        ...
        var e, n = es(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new $u(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return ca(u.syncEngine, t, 0 /* RemoteStore */);
        }, o = Yu.V() ? new Yu : new Hu, new as(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, u) {
            var s = new ra(t, e, n, r, i, o);
            return u && (s.ac = !0), s;
 ...
 */ var Ba = /** @class */ function() {
    ...
    return t.prototype.next = function(t) {
        ...
        this.observer.error ? this.Ic(this.observer.error, t) : B("Uncaught Error in snapshot listener:", t);
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return i = n.sent(), [ 2 /*return*/ , new Hs(JSON.parse(i), t.length + r) ];
                }
            }));
        }));
    }, 
    ...
    return t.prototype.lookup = function(t) {
                    ...
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = W(t), i = jr(e.wt) + "/documents", o = {
                                    ...
                                    return u = n.sent(), s = new Map, u.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Br(t, e.found.name), r = Lr(e.found.updateTime), i = new Fe({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Pe.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                z(!!e.missing), z(!!e.readTime);
                                                var n = Br(t, e.missing), r = Lr(e.readTime);
        ...
        this.write(new rr(t, this.precondition(t))), this.writtenDocs.add(t.toString());
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var n = mt.fromPath(e);
                        r.mutations.push(new ir(n, r.precondition(n)));
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? Kn.updateTime(e) : Kn.none();
    }, 
    /**
    ...
    function t(t, e, n, r, i) {
        ...
        this.deferred = i, this.Dc = n.maxAttempts, this.So = new ns(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.So.Io((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new Ga(this.datastore), (e = this.xc(t)) && e.then((function(e) {
        ...
        try {
            ...
            return !fe(e) && e.catch && e.then ? e : (this.deferred.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
        ...
        if ("FirebaseError" === t.name) {
            ...
            var e = t.code;
            return "aborted" === e || "failed-precondition" === e || !ur(e);
        }
        return !1;
    }, t;
}(), za = /** @class */ function() {
            ...
            return e(t, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 5:
                        return t = n.sent(), e = Fs(t, "Failed to shutdown persistence"), r.reject(e), [ 3 /*break*/ , 6 ];
                ...
                return s.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return e(u, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Su(r.localStore, t) ];
...
function Wa(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Ha(t) ];
              ...
              case 3:
                ...
                t.setCredentialChangeListener((function(t) {
                    return Cs(r.remoteStore, t);
                })), t.setAppCheckTokenChangeListener((function(t, e) {
                    return Cs(r.remoteStore, e);
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return e = n.sent(), [ 2 /*return*/ , ((r = e.eventManager).onListen = ia.bind(null, e.syncEngine), 
                r.onUnlisten = ua.bind(null, e.syncEngine), r) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function ec(t, r, i) {
    var o = this;
    void 0 === i && (i = {});
    var u = new J;
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function ac(t) {
 ...
 */ var hc = /** @class */ function() {
    ...
    function t(t, e, n) {
        ...
        this._settingsFrozen = !1, t instanceof he ? this._databaseId = t : (this._app = t, 
 ...
 */
        return t = this, (e = rc.get(t)) && (U("ComponentProvider", "Removing Datastore"), 
        rc.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ var pc = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, ln(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function mc(t, e) {
    ...
    if (t = I(t), ic("collection", "path", e), t instanceof fc) {
        var o = pt.fromString.apply(pt, r([ e ], n));
        return sc(o), new yc(t, /* converter= */ null, o);
    }
    if (!(t instanceof pc || t instanceof yc)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t._path.child(pt.fromString.apply(pt, r([ e ], n)));
    return sc(u), new yc(t.firestore, 
    /* converter= */ null, u);
}
 ...
 */ function gc(t, e) {
    if (t = cc(t, fc), ic("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Y(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new vc(t, 
    /* converter= */ null, 
    /**
...
function wc(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = st.I()), ic("doc", "path", e), t instanceof fc) {
        var o = pt.fromString.apply(pt, r([ e ], n));
        return uc(o), new pc(t, 
        /* converter= */ null, new mt(o));
    }
    if (!(t instanceof pc || t instanceof yc)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var u = t._path.child(pt.fromString.apply(pt, r([ e ], n)));
    return uc(u), new pc(t.firestore, t instanceof yc ? t.converter : null, new mt(u));
}
 ...
 * Firestore database.
 */ function bc(t, e) {
    return t = I(t), e = I(e), (t instanceof pc || t instanceof yc) && (e instanceof pc || e instanceof yc) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function Ic(t, e) {
    return t = I(t), e = I(e), t instanceof vc && e instanceof vc && t.firestore === e.firestore && gn(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var Ec = /** @class */ function() {
    function t() {
        ...
        this.So = new ns(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.jc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.Oc.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Oc[0]() ];

                  case 2:
                    return n.sent(), this.Oc.shift(), this.So.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!Lt(t = n.sent())) throw t;
        ...
        var e = this, n = this.Mc.then((function() {
 ...
 */
        ...
        var i = Rs.createAndSchedule(this, t, e, n, (function(t) {
            return r.Wc(t);
        }));
    ...
    t.prototype.zc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.Mc ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.Mc) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
...
var Sc = /** @class */ function() {
    ...
    function n(t, n, r) {
        ...
        /**
             ...
             */
        return (i = e.call(this, t, n, r) || this).type = "firestore", i._queue = new Ec, 
...
function kc(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new le(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new za(t._authCredentials, t._appCheckCredentials, t._queue, r);
}
 ...
 */ function Cc(t, e) {
    Bc(t = cc(t, xc));
    var n = Ac(t), r = t._freezeSettings(), i = new qa;
    return Vc(n, i, new La(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Oc(t) {
    Bc(t = cc(t, xc));
    var e = Ac(t), n = t._freezeSettings(), r = new qa;
    return Vc(e, r, new Pa(r, n.cacheSizeBytes));
}
 ...
 */ function Vc(t, r, i) {
    ...
    return t.asyncQueue.enqueue((function() {
         ...
         */
                    ...
                    return K("Error enabling offline persistence. Falling back to persistence disabled: " + o), 
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return Mt.V() ? (e = t + "main", [ 4 /*yield*/ , Mt.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(wu(t._databaseId, t._persistenceKey)) ];
 ...
 */ function Fc(t) {
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), [ 4 /*yield*/ , $a(t) ];

                      case 2:
                        return r = n.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e.lu.delete(0 /* UserDisabled */), cs(e);
                        }(r)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (Ac(t = cc(t, xc)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (r.setNetworkEnabled(!1), function(t) {
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).lu.add(0 /* UserDisabled */), [ 4 /*yield*/ , ls(e) ];
...
function Uc(t, r) {
    ...
    }(Ac(t = cc(t, xc)), r).then((function(e) {
        return e ? new vc(t, null, e.query) : null;
    }));
}
 ...
 */ var jc = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            return new t(ne.fromBase64String(e));
        } catch (e) {
     ...
     */
    t.fromUint8Array = function(e) {
        return new t(ne.fromUint8Array(e));
    }, 
    /**
...
}(), Wc = /^__.*__$/, Hc = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Xn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Jn(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Yc = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Xc = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.ta = function(e) {
        ...
        return ml(t, this.settings.methodName, this.settings.ua || !1, this.path, this.settings.ca);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Jc(this.Zc) && Wc.test(t)) throw this.oa('Document fields cannot begin and end with "__"');
    }, t;
}(), $c = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.wt = n || es(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.aa = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Xc({
            Zc: t,
            methodName: e,
            ca: n,
            path: yt.emptyPath(),
 ...
 * classes.
 */ function Zc(t) {
    var e = t._freezeSettings(), n = es(t._databaseId);
    return new $c(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function tl(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var u = t.aa(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    dl("Data must be an object, but it was:", u, r);
    var s, a, c = hl(r, u);
    if (o.merge) s = new te(u.fieldMask), a = u.fieldTransforms; else if (o.mergeFields) {
        ...
        s = new te(l), a = u.fieldTransforms.filter((function(t) {
            return s.covers(t.field);
        }));
    } else s = null, a = u.fieldTransforms;
    return new Hc(new Fe(c), s, a);
}
...
var rl = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new Un(t.path, new On);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(zc), il = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
}(zc), ul = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).la = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Ln(t.wt, _n(t.wt, this.la));
...
/** Parse update data from an update() call. */ function sl(t, e, n, r) {
    var i = t.aa(1 /* Update */ , e, n);
    dl("Data must be an object, but it was:", i, r);
    var o = [], u = Fe.empty();
    Qt(r, (function(t, r) {
        var s = yl(e, t, n);
    ...
    var s = new te(o);
    return new Yc(u, s, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function al(t, e, n, r, i, o) {
    var u = t.aa(1 /* Update */ , e, n), s = [ pl(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) s.push(pl(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var l = [], h = Fe.empty(), f = s.length - 1; f >= 0; --f) if (!gl(l, s[f])) {
        var d = s[f], p = a[f];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
    ...
    var m = new te(l);
    return new Yc(h, m, u.fieldTransforms);
}
 ...
 */ function cl(t, e, n, r) {
    return void 0 === r && (r = !1), ll(n, t.aa(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function ll(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return dl("Unsupported field value:", e, t), hl(t, e);
    if (t instanceof zc) 
    ...
    return function(t, e) {
        ...
        if (!Jc(e.Zc)) throw e.oa(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return _n(e.wt, t);
        ...
        if (t instanceof jc) return {
            bytesValue: Rr(e.wt, t._byteString)
        };
        if (t instanceof pc) {
            ...
            return {
                referenceValue: Pr(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.oa("Unsupported field value: " + ac(t));
    }(t, e);
}
...
function hl(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : Qt(t, (function(t, r) {
        var i = ll(r, e.ea(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function fl(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ht || t instanceof Qc || t instanceof jc || t instanceof pc || t instanceof zc);
}
 ...
 */ function pl(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof Kc) return e._internalPath;
    if ("string" == typeof e) return yl(t, e);
    throw ml("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function yl(t, e, n) {
    if (e.search(vl) >= 0) throw ml("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (Kc.bind.apply(Kc, r([ void 0 ], e.split(".")))))._internalPath;
    } catch (r) {
 ...
 */ var wl = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new bl(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(Il("DocumentSnapshot.get", t));
 ...
 */
function Il(t, e) {
    return "string" == typeof e ? yl(t, e) : e instanceof Kc ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var El = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new Sl(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(Il("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(wl), Sl = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
...
}(Tl), Dl = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new El(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Sl(n._firestore, n._userDataWriter, r.key, r, new El(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new Sl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new El(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Sl(t._firestore, t._userDataWriter, e.doc.key, e.doc, new El(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 */ function _l(t, e) {
    return t instanceof Tl && e instanceof Tl ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Dl && e instanceof Dl && t._firestore === e._firestore && Ic(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot);
}
...
var Cl = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Zc(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.isKeyField()) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || Ql(u, o), 
            s = cl(n, "where", u, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var f = We.create(i, o, s);
            return function(t, e) {
                if (e.ht()) {
                    var n = dn(t);
...
var Rl = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new vc(t.firestore, t.converter, mn(t._query, this.ma, this.ga));
    }, n;
}(Al);
 ...
 * @returns The created {@link Query}.
 */ function Fl(t) {
    return lc("limit", t), new Rl("limit", t, "F" /* First */)
    /**
...
function Ll(t) {
    return lc("limitToLast", t), new Rl("limitToLast", t, "L" /* Last */);
}
...
var Pl = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = jl(t, this.type, this.ya, this.pa);
        return new vc(t.firestore, t.converter, function(t, e) {
...
function ql() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Pl("startAt", t, 
    /*inclusive=*/ !0);
}

function Ul() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Pl("startAfter", t, 
    /*inclusive=*/ !1);
}
...
function Kl() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Bl("endBefore", t, 
    /*inclusive=*/ !1);
}

function Gl() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Bl("endAt", t, /*inclusive=*/ !0);
}

/** Helper function to create a bound from a document or fields */ function jl(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof wl) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], u = 0, s = vn(t); u < s.length; u++) {
            var a = s[u];
            if (a.field.isKeyField()) o.push(Se(e, r.key)); else {
                var c = r.data.field(a.field);
                if (se(c)) throw new Y(H.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var s = [], a = 0; a < i.length; a++) {
            ...
            if (u[a].field.isKeyField()) {
                ...
                if (!pn(t) && -1 !== c.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
...
function zl(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        ...
        if (!pn(e) && -1 !== n.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        ...
        return Se(t, new mt(r));
    }
    if (n instanceof pc) return Se(t, n._key);
    throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: " + ac(n) + ".");
}
 ...
 */ var Hl = {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        var n = this, r = {};
        return Qt(t.fields, (function(t, i) {
            r[t] = n.convertValue(i, e);
        })), r;
    }, t.prototype.convertGeoPoint = function(t) {
        return new Qc(oe(t.latitude), oe(t.longitude));
        ...
        switch (e) {
          ...
          case "estimate":
            return this.convertTimestamp(ce(t));
        ...
        z(si(n));
        var r = new he(n.get(1), n.get(3)), i = new mt(n.popFirst(5));
        return r.isEqual(e) || 
...
var Xl = /** @class */ function(e) {
    ...
    function t(t, e) {
        ...
        this._dataReader = Zc(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = Zl(t, this._firestore), i = Jl(r.converter, e, n), o = tl(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, Kn.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, u = Zl(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Kc ? al(this._dataReader, "WriteBatch.update", u._key, e, n, r) : sl(this._dataReader, "WriteBatch.update", u._key, e), 
        this._mutations.push(o.toMutation(u._key, Kn.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Zl(t, this._firestore);
        return this._mutations = this._mutations.concat(new rr(e._key, Kn.none())), this;
    }, 
    /**
 ...
 */ function th(t) {
    t = cc(t, pc);
    var e = cc(t.firestore, xc);
    return ec(Ac(e), t._key).then((function(n) {
        return ph(e, t, n);
    }));
}
 ...
 */ function nh(t) {
    t = cc(t, pc);
    var r = cc(t.firestore, xc), i = Ac(r), o = new eh(r);
    return function(t, r) {
        var i = this, o = new J;
        return t.asyncQueue.enqueueAndForget((function() {
            return e(i, void 0, void 0, (function() {
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 2:
                                        return o = n.sent(), u = Fs(o, "Failed to get document '" + r + " from cache"), 
        ...
        return new Tl(r, o, t._key, e, new El(null !== e && e.hasLocalMutations, 
 ...
 */ function ih(t) {
    t = cc(t, vc);
    var e = cc(t.firestore, xc), n = Ac(e), r = new eh(e);
    return Nl(t._query), nc(n, t._query).then((function(n) {
        return new Dl(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, r, i) {
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , Ou(t, r, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return e = n.sent(), o = new ta(r, e.ji), u = o.Ku(e.documents), s = o.applyChanges(u, 
                                        /* updateLimboDocuments= */ !1), i.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = n.sent(), c = Fs(a, "Failed to execute query '" + r + " against cache"), 
...
function sh(t, e, n) {
    t = cc(t, pc);
    var r = cc(t.firestore, xc), i = Jl(t.converter, e, n);
    return dh(r, [ tl(Zc(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Kn.none()) ]);
}

function ah(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = cc(t, pc);
    var o = cc(t.firestore, xc), u = Zc(o);
    return dh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof Kc ? al(u, "updateDoc", t._key, e, n, r) : sl(u, "updateDoc", t._key, e)).toMutation(t._key, Kn.exists(!0)) ]);
}
 ...
 */ function ch(t) {
    return dh(cc(t.firestore, xc), [ new rr(t._key, Kn.none()) ]);
}
 ...
 */ function lh(t, e) {
    var n = cc(t.firestore, xc), r = wc(t), i = Jl(t.converter, e);
    return dh(n, [ tl(Zc(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Kn.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function hh(t) {
    ...
    if (t instanceof pc) h = cc(t.firestore, xc), f = ln(t._key.path), l = {
        next: function(e) {
            u[c] && u[c](ph(h, t, e));
        },
        error: u[c + 1],
        ...
        var v = cc(t, vc);
        h = cc(v.firestore, xc), f = v._query;
        var y = new eh(h);
        l = {
            next: function(t) {
                u[c] && u[c](new Dl(h, y, v, t));
            },
            error: u[c + 1],
            complete: u[c + 2]
        }, Nl(t._query);
    ...
    return function(t, r, i, o) {
        var u = this, s = new Ba(o), a = new Ws(r, s, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return e(u, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
 ...
 */ function ph(t, e, n) {
    var r = n.docs.get(e._key), i = new eh(t);
    return new Tl(t, i, e._key, r, new El(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var vh, yh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Zl(t, this._firestore), i = new eh(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new Tl(n._firestore, i, r._key, t._document, new El(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Zc(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Zl(t, this._firestore), r = new Xl(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return j();
            var i = t[0];
            if (i.isFoundDocument()) return new wl(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new wl(e._firestore, r, n._key, null, n.converter);
            throw j();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Zl(t, this._firestore), i = Jl(r.converter, e, n), o = tl(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Kc ? al(this._dataReader, "Transaction.update", u._key, e, n, r) : sl(this._dataReader, "Transaction.update", u._key, e), 
 ...
 */ function mh(t, r, i) {
    t = cc(t, xc);
    var o = Object.assign(Object.assign({}, Hl), i);
    return function(t) {
            ...
            return e(o, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), new ja(t.asyncQueue, e, i, r, u).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), u.promise;
 ...
 * writes.
 */ function Th(t) {
    return Ac(t = cc(t, xc)), new $l(t, (function(e) {
        return dh(t, e);
    }))
    /**
 * @license
...
function Sh(t, i) {
    var o, u = Ac(t = cc(t, xc));
    // PORTING NOTE: We don't return an error if the user has not enabled
    // persistence since `enableIndexeddbPersistence()` can fail on the Web.
    if (!(null === (o = u.offlineComponents) || void 0 === o ? void 0 : o.indexBackfillerScheduler)) return K("Cannot enable indexes when persistence is disabled"), 
    Promise.resolve();
    var s = function(t) {
        ...
        if (Array.isArray(e.indexes)) for (var r = 0, i = e.indexes; r < i.length; r++) {
            var o = i[r], u = Dh(o, "collectionGroup"), s = [];
            if (Array.isArray(o.fields)) for (var a = 0, c = o.fields; a < c.length; a++) {
                var l = c[a], h = yl("setIndexConfiguration", Dh(l, "fieldPath"));
                "CONTAINS" === l.arrayConfig ? s.push(new Et(h, 2 /* CONTAINS */)) : "ASCENDING" === l.order ? s.push(new Et(h, 0 /* ASCENDING */)) : "DESCENDING" === l.order && s.push(new Et(h, 1 /* DESCENDING */));
            }
            n.push(new gt(gt.UNKNOWN_ID, u, s, St.empty()));
        }
        return n;
    }(i);
    return Xa(u).then((function(t) {
        return function(t, i) {
            return e(this, void 0, void 0, (function() {
                var e, o, u;
                return n(this, (function(n) {
                    return e = W(t), o = e.indexManager, u = [], [ 2 /*return*/ , e.persistence.runTransaction("Configure indexes", "readwrite", (function(t) {
                        return o.getFieldIndexes(t).next((function(e) {
                            return function(t, e, n, i, o) {
                                t = r([], t), e = r([], e), t.sort(n), e.sort(n);
                                for (var u = t.length, s = e.length, a = 0, c = 0; a < s && c < u; ) {
                                    var l = n(t[c], e[a]);
                                    l < 0 ? 
                                    // The element was removed if the next element in our ordered
                                    // walkthrough is only in `before`.
 ...
 */ void 0 === vh && (vh = !0), F = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new xc(r, new tt(t.getProvider("auth-internal")), new it(t.getProvider("app-check-internal")));
    return n = Object.assign({
        useFetchStreams: vh
    }, n), i._setSettings(n), i;
}), "PUBLIC")), u(M, "3.4.14", void 0), 
// BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
u(M, "3.4.14", "esm5");

export { Yl as AbstractUserDataWriter, jc as Bytes, Dc as CACHE_SIZE_UNLIMITED, yc as CollectionReference, pc as DocumentReference, Tl as DocumentSnapshot, Kc as FieldPath, zc as FieldValue, xc as Firestore, Y as FirestoreError, Qc as GeoPoint, Sc as LoadBundleTask, vc as Query, Al as QueryConstraint, Sl as QueryDocumentSnapshot, Dl as QuerySnapshot, El as SnapshotMetadata, ht as Timestamp, yh as Transaction, $l as WriteBatch, he as _DatabaseId, mt as _DocumentKey, ot as _EmptyAppCheckTokenProvider, $ as _EmptyAuthCredentialsProvider, yt as _FieldPath, cc as _cast, Q as _debugAssert, ee as _isBase64Available, K as _logWarn, oc as _validateIsNotUsedTogether, lh as addDoc, Ih as arrayRemove, bh as arrayUnion, Mc as clearIndexedDbPersistence, mc as collection, gc as collectionGroup, dc as connectFirestoreEmulator, ch as deleteDoc, gh as deleteField, Lc as disableNetwork, wc as doc, Gc as documentId, Cc as enableIndexedDbPersistence, Oc as enableMultiTabIndexedDbPersistence, Fc as enableNetwork, Gl as endAt, Kl as endBefore, Ac as ensureFirestoreConfigured, dh as executeWrite, th as getDoc, nh as getDocFromCache, rh as getDocFromServer, ih as getDocs, oh as getDocsFromCache, uh as getDocsFromServer, Nc as getFirestore, Eh as increment, _c as initializeFirestore, Fl as limit, Ll as limitToLast, qc as loadBundle, Uc as namedQuery, hh as onSnapshot, fh as onSnapshotsInSync, Ml as orderBy, kl as query, Ic as queryEqual, bc as refEqual, mh as runTransaction, wh as serverTimestamp, sh as setDoc, Sh as setIndexConfiguration, q as setLogLevel, _l as snapshotEqual, Ul as startAfter, ql as startAt, Pc as terminate, ah as updateDoc, Rc as waitForPendingWrites, Ol as where, Th as writeBatch };
